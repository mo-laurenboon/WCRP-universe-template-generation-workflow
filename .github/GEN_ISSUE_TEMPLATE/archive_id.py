...
TEMPLATE_CONFIG = {
    "name": "Add/Modify: archive_id",
    "description": "Add or modify archive_id in WCRP Universe",
    "title": "Add/Modify: archive_id: <Type activity name here>",
    "labels": ["archive_id", "cv-submission"]
}
