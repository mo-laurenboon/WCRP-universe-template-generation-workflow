...
TEMPLATE_CONFIG = {
    "name": "Add/Modify: native_horizontal_grid_region",
    "description": "Add or modify native_horizontal_grid_region in WCRP Universe",
    "title": "Add/Modify: native_horizontal_grid_region: <Type activity name here>",
    "labels": ["native_horizontal_grid_region", "cv-submission"]
}
