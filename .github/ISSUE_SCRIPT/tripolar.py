#!/usr/bin/env python3
"""
Handler for tripolar submissions.
"""

import json
from pathlib import Path

def validate_tripolar(data):
    """
    Validate tripolar submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing tripolar submission...")

    #Validate
    errors = validate_tripolar(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_tripolar_json(parsed_data)

    #Write file
    output_dir = Path("tripolar")
