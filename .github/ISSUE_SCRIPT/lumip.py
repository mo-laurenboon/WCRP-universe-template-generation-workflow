#!/usr/bin/env python3
"""
Handler for lumip submissions.
"""

import json
from pathlib import Path

def validate_lumip(data):
    """
    Validate lumip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing lumip submission...")

    #Validate
    errors = validate_lumip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_lumip_json(parsed_data)

    #Write file
    output_dir = Path("lumip")
