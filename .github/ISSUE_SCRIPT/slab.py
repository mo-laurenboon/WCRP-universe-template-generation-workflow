#!/usr/bin/env python3
"""
Handler for slab submissions.
"""

import json
from pathlib import Path

def validate_slab(data):
    """
    Validate slab submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing slab submission...")

    #Validate
    errors = validate_slab(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_slab_json(parsed_data)

    #Write file
    output_dir = Path("slab")
