#!/usr/bin/env python3
"""
Handler for air-potential-temperature submissions.
"""

import json
from pathlib import Path

def validate_air_potential_temperature(data):
    """
    Validate air-potential-temperature submission.
...
def create_air_potential_temperature_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing air-potential-temperature submission...")

    #Validate
    errors = validate_air_potential_temperature(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_air_potential_temperature_json(parsed_data)

    #Write file
    output_dir = Path("air-potential-temperature")
    ...
    return {
        ...
        "category": "air-potential-temperature",
        "id": entry_id
    }