#!/usr/bin/env python3
"""
Handler for miroc submissions.
"""

import json
from pathlib import Path

def validate_miroc(data):
    """
    Validate miroc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing miroc submission...")

    #Validate
    errors = validate_miroc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_miroc_json(parsed_data)

    #Write file
    output_dir = Path("miroc")
