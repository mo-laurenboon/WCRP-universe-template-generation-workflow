#!/usr/bin/env python3
"""
Handler for grz submissions.
"""

import json
from pathlib import Path

def validate_grz(data):
    """
    Validate grz submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing grz submission...")

    #Validate
    errors = validate_grz(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_grz_json(parsed_data)
