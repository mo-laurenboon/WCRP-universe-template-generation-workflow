#!/usr/bin/env python3
"""
Handler for bcc submissions.
"""

import json
from pathlib import Path

def validate_bcc(data):
    """
    Validate bcc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing bcc submission...")

    #Validate
    errors = validate_bcc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_bcc_json(parsed_data)
