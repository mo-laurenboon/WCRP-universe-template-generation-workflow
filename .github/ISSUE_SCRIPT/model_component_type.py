#!/usr/bin/env python3
"""
Handler for model_component_type submissions.
"""
...
def validate_model_component_type(data):
    """
    Validate model_component_type submission.
...
def create_model_component_type_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing model_component_type submission...")

    #Validate
    errors = validate_model_component_type(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_model_component_type_json(parsed_data)

    #Write file
    output_dir = Path("model_component_type")
