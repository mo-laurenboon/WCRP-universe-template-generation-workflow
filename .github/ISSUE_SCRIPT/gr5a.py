#!/usr/bin/env python3
"""
Handler for gr5a submissions.
"""

import json
from pathlib import Path

def validate_gr5a(data):
    """
    Validate gr5a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr5a submission...")

    #Validate
    errors = validate_gr5a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr5a_json(parsed_data)

    #Write file
    output_dir = Path("gr5a")
