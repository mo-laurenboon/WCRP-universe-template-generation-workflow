#!/usr/bin/env python3
"""
Handler for noaa-ncei submissions.
"""

import json
from pathlib import Path

def validate_noaa_ncei(data):
    """
    Validate noaa-ncei submission.
...
def create_noaa_ncei_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing noaa-ncei submission...")

    #Validate
    errors = validate_noaa_ncei(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_noaa_ncei_json(parsed_data)

    #Write file
    output_dir = Path("noaa-ncei")
