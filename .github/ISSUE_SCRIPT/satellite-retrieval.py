#!/usr/bin/env python3
"""
Handler for satellite-retrieval submissions.
"""

import json
from pathlib import Path

def validate_satellite_retrieval(data):
    """
    Validate satellite-retrieval submission.
...
def create_satellite_retrieval_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing satellite-retrieval submission...")

    #Validate
    errors = validate_satellite_retrieval(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_satellite_retrieval_json(parsed_data)

    #Write file
    output_dir = Path("satellite-retrieval")
