#!/usr/bin/env python3
"""
Handler for 1hrcm submissions.
"""

import json
from pathlib import Path

def validate_1hrcm(data):
    """
    Validate 1hrcm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1hrcm submission...")

    #Validate
    errors = validate_1hrcm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1hrcm_json(parsed_data)

    #Write file
    output_dir = Path("1hrcm")
