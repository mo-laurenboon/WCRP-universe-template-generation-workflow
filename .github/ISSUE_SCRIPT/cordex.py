#!/usr/bin/env python3
"""
Handler for cordex submissions.
"""

import json
from pathlib import Path

def validate_cordex(data):
    """
    Validate cordex submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cordex submission...")

    #Validate
    errors = validate_cordex(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cordex_json(parsed_data)

    #Write file
    output_dir = Path("cordex")
