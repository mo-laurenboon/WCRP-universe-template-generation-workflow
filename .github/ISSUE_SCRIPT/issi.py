#!/usr/bin/env python3
"""
Handler for issi submissions.
"""

import json
from pathlib import Path

def validate_issi(data):
    """
    Validate issi submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing issi submission...")

    #Validate
    errors = validate_issi(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_issi_json(parsed_data)

    #Write file
    output_dir = Path("issi")
