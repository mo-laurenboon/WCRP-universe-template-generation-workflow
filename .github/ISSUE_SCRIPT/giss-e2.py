#!/usr/bin/env python3
"""
Handler for giss-e2 submissions.
"""

import json
from pathlib import Path

def validate_giss_e2(data):
    """
    Validate giss-e2 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing giss-e2 submission...")

    #Validate
    errors = validate_giss_e2(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_giss_e2_json(parsed_data)

    #Write file
    output_dir = Path("giss-e2")
