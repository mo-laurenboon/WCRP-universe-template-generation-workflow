#!/usr/bin/env python3
"""
Handler for mpi-esm submissions.
"""

import json
from pathlib import Path

def validate_mpi_esm(data):
    """
    Validate mpi-esm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mpi-esm submission...")

    #Validate
    errors = validate_mpi_esm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mpi_esm_json(parsed_data)

    #Write file
    output_dir = Path("mpi-esm")
