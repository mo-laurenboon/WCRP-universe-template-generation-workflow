#!/usr/bin/env python3
"""
Handler for ucolorado submissions.
"""

import json
from pathlib import Path

def validate_ucolorado(data):
    """
    Validate ucolorado submission.
...
def create_ucolorado_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ucolorado submission...")

    #Validate
    errors = validate_ucolorado(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ucolorado_json(parsed_data)

    #Write file
    output_dir = Path("ucolorado")
