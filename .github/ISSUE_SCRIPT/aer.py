#!/usr/bin/env python3
"""
Handler for aer submissions.
"""

import json
from pathlib import Path

def validate_aer(data):
    """
    Validate aer submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aer submission...")

    #Validate
    errors = validate_aer(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aer_json(parsed_data)
