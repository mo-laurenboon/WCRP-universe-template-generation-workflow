#!/usr/bin/env python3
"""
Handler for ceda submissions.
"""

import json
from pathlib import Path

def validate_ceda(data):
    """
    Validate ceda submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ceda submission...")

    #Validate
    errors = validate_ceda(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ceda_json(parsed_data)

    #Write file
    output_dir = Path("ceda")
