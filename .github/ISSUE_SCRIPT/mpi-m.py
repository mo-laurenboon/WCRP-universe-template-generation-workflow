#!/usr/bin/env python3
"""
Handler for mpi-m submissions.
"""

import json
from pathlib import Path

def validate_mpi_m(data):
    """
    Validate mpi-m submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mpi-m submission...")

    #Validate
    errors = validate_mpi_m(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mpi_m_json(parsed_data)

    #Write file
    output_dir = Path("mpi-m")
