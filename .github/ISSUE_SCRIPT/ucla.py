#!/usr/bin/env python3
"""
Handler for ucla submissions.
"""

import json
from pathlib import Path

def validate_ucla(data):
    """
    Validate ucla submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ucla submission...")

    #Validate
    errors = validate_ucla(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ucla_json(parsed_data)

    #Write file
    output_dir = Path("ucla")
