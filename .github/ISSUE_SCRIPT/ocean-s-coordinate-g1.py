#!/usr/bin/env python3
"""
Handler for ocean-s-coordinate-g1 submissions.
"""

import json
from pathlib import Path

def validate_ocean_s_coordinate_g1(data):
    """
    Validate ocean-s-coordinate-g1 submission.
...
def create_ocean_s_coordinate_g1_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocean-s-coordinate-g1 submission...")

    #Validate
    errors = validate_ocean_s_coordinate_g1(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocean_s_coordinate_g1_json(parsed_data)

    #Write file
    output_dir = Path("ocean-s-coordinate-g1")
    ...
    return {
        ...
        "category": "ocean-s-coordinate-g1",
        "id": entry_id
    }