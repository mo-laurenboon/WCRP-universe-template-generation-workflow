#!/usr/bin/env python3
"""
Handler for sea-water-pressure submissions.
"""

import json
from pathlib import Path

def validate_sea_water_pressure(data):
    """
    Validate sea-water-pressure submission.
...
def create_sea_water_pressure_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing sea-water-pressure submission...")

    #Validate
    errors = validate_sea_water_pressure(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_sea_water_pressure_json(parsed_data)

    #Write file
    output_dir = Path("sea-water-pressure")
