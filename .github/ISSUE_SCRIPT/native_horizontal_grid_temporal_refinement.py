#!/usr/bin/env python3
"""
Handler for native_horizontal_grid_temporal_refinement submissions.
"""

import json
from pathlib import Path

def validate_native_horizontal_grid_temporal_refinement(data):
    """
    Validate native_horizontal_grid_temporal_refinement submission.
...
def create_native_horizontal_grid_temporal_refinement_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing native_horizontal_grid_temporal_refinement submission...")

    #Validate
    errors = validate_native_horizontal_grid_temporal_refinement(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_native_horizontal_grid_temporal_refinement_json(parsed_data)

    #Write file
    output_dir = Path("native_horizontal_grid_temporal_refinement")
    ...
    return {
        ...
        "category": "native_horizontal_grid_temporal_refinement",
        "id": entry_id
    }