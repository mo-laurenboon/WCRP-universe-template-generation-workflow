#!/usr/bin/env python3
"""
Handler for spectral-gaussian submissions.
"""

import json
from pathlib import Path

def validate_spectral_gaussian(data):
    """
    Validate spectral-gaussian submission.
...
def create_spectral_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing spectral-gaussian submission...")

    #Validate
    errors = validate_spectral_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_spectral_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("spectral-gaussian")
