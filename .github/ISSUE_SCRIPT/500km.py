#!/usr/bin/env python3
"""
Handler for 500km submissions.
"""

import json
from pathlib import Path

def validate_500km(data):
    """
    Validate 500km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 500km submission...")

    #Validate
    errors = validate_500km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_500km_json(parsed_data)

    #Write file
    output_dir = Path("500km")
