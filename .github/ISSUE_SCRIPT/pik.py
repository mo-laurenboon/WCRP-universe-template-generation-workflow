#!/usr/bin/env python3
"""
Handler for pik submissions.
"""

import json
from pathlib import Path

def validate_pik(data):
    """
    Validate pik submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pik submission...")

    #Validate
    errors = validate_pik(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pik_json(parsed_data)
