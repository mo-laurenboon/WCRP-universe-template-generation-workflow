#!/usr/bin/env python3
"""
Handler for seaice submissions.
"""

import json
from pathlib import Path

def validate_seaice(data):
    """
    Validate seaice submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing seaice submission...")

    #Validate
    errors = validate_seaice(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_seaice_json(parsed_data)

    #Write file
    output_dir = Path("seaice")
