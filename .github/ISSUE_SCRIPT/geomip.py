#!/usr/bin/env python3
"""
Handler for geomip submissions.
"""

import json
from pathlib import Path

def validate_geomip(data):
    """
    Validate geomip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing geomip submission...")

    #Validate
    errors = validate_geomip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_geomip_json(parsed_data)

    #Write file
    output_dir = Path("geomip")
