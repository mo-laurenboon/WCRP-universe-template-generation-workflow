#!/usr/bin/env python3
"""
Handler for gnz submissions.
"""

import json
from pathlib import Path

def validate_gnz(data):
    """
    Validate gnz submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gnz submission...")

    #Validate
    errors = validate_gnz(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gnz_json(parsed_data)
