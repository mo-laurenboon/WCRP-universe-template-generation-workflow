#!/usr/bin/env python3
"""
Handler for gr7a submissions.
"""

import json
from pathlib import Path

def validate_gr7a(data):
    """
    Validate gr7a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr7a submission...")

    #Validate
    errors = validate_gr7a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr7a_json(parsed_data)

    #Write file
    output_dir = Path("gr7a")
