#!/usr/bin/env python3
"""
Handler for nasa submissions.
"""

import json
from pathlib import Path

def validate_nasa(data):
    """
    Validate nasa submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nasa submission...")

    #Validate
    errors = validate_nasa(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nasa_json(parsed_data)

    #Write file
    output_dir = Path("nasa")
