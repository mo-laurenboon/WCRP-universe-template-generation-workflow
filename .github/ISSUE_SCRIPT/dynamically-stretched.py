#!/usr/bin/env python3
"""
Handler for dynamically-stretched submissions.
"""

import json
from pathlib import Path

def validate_dynamically_stretched(data):
    """
    Validate dynamically-stretched submission.
...
def create_dynamically_stretched_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing dynamically-stretched submission...")

    #Validate
    errors = validate_dynamically_stretched(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_dynamically_stretched_json(parsed_data)

    #Write file
    output_dir = Path("dynamically-stretched")
    ...
    return {
        ...
        "category": "dynamically-stretched",
        "id": entry_id
    }