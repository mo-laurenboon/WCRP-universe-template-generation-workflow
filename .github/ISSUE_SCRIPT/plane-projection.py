#!/usr/bin/env python3
"""
Handler for plane-projection submissions.
"""

import json
from pathlib import Path

def validate_plane_projection(data):
    """
    Validate plane-projection submission.
...
def create_plane_projection_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing plane-projection submission...")

    #Validate
    errors = validate_plane_projection(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_plane_projection_json(parsed_data)

    #Write file
    output_dir = Path("plane-projection")
