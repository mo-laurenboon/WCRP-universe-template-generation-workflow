#!/usr/bin/env python3
"""
Handler for bgc submissions.
"""

import json
from pathlib import Path

def validate_bgc(data):
    """
    Validate bgc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing bgc submission...")

    #Validate
    errors = validate_bgc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_bgc_json(parsed_data)
