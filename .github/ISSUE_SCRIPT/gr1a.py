#!/usr/bin/env python3
"""
Handler for gr1a submissions.
"""

import json
from pathlib import Path

def validate_gr1a(data):
    """
    Validate gr1a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr1a submission...")

    #Validate
    errors = validate_gr1a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr1a_json(parsed_data)

    #Write file
    output_dir = Path("gr1a")
