#!/usr/bin/env python3
"""
Handler for ocnbgchem submissions.
"""

import json
from pathlib import Path

def validate_ocnbgchem(data):
    """
    Validate ocnbgchem submission.
...
def create_ocnbgchem_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocnbgchem submission...")

    #Validate
    errors = validate_ocnbgchem(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocnbgchem_json(parsed_data)

    #Write file
    output_dir = Path("ocnbgchem")
