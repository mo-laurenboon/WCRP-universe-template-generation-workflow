#!/usr/bin/env python3
"""
Handler for gr submissions.
"""

import json
from pathlib import Path

def validate_gr(data):
    """
    Validate gr submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr submission...")

    #Validate
    errors = validate_gr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr_json(parsed_data)
