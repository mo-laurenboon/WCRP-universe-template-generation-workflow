#!/usr/bin/env python3
"""
Handler for gr6z submissions.
"""

import json
from pathlib import Path

def validate_gr6z(data):
    """
    Validate gr6z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr6z submission...")

    #Validate
    errors = validate_gr6z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr6z_json(parsed_data)

    #Write file
    output_dir = Path("gr6z")
