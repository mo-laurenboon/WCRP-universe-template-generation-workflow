#!/usr/bin/env python3
"""
Handler for uoleeds submissions.
"""

import json
from pathlib import Path

def validate_uoleeds(data):
    """
    Validate uoleeds submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uoleeds submission...")

    #Validate
    errors = validate_uoleeds(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uoleeds_json(parsed_data)

    #Write file
    output_dir = Path("uoleeds")
