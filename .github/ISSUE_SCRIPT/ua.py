#!/usr/bin/env python3
"""
Handler for ua submissions.
"""

import json
from pathlib import Path

def validate_ua(data):
    """
    Validate ua submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ua submission...")

    #Validate
    errors = validate_ua(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ua_json(parsed_data)
