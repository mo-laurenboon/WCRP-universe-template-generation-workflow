#!/usr/bin/env python3
"""
Handler for uom submissions.
"""

import json
from pathlib import Path

def validate_uom(data):
    """
    Validate uom submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uom submission...")

    #Validate
    errors = validate_uom(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uom_json(parsed_data)
