#!/usr/bin/env python3
"""
Handler for ncc submissions.
"""

import json
from pathlib import Path

def validate_ncc(data):
    """
    Validate ncc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ncc submission...")

    #Validate
    errors = validate_ncc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ncc_json(parsed_data)
