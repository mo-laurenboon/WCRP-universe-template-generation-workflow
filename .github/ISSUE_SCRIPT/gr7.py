#!/usr/bin/env python3
"""
Handler for gr7 submissions.
"""

import json
from pathlib import Path

def validate_gr7(data):
    """
    Validate gr7 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr7 submission...")

    #Validate
    errors = validate_gr7(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr7_json(parsed_data)
