#!/usr/bin/env python3
"""
Handler for gr1g submissions.
"""

import json
from pathlib import Path

def validate_gr1g(data):
    """
    Validate gr1g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr1g submission...")

    #Validate
    errors = validate_gr1g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr1g_json(parsed_data)

    #Write file
    output_dir = Path("gr1g")
