#!/usr/bin/env python3
"""
Handler for yrpt submissions.
"""

import json
from pathlib import Path

def validate_yrpt(data):
    """
    Validate yrpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing yrpt submission...")

    #Validate
    errors = validate_yrpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_yrpt_json(parsed_data)

    #Write file
    output_dir = Path("yrpt")
