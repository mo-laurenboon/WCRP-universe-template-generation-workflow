#!/usr/bin/env python3
"""
Handler for derived submissions.
"""

import json
from pathlib import Path

def validate_derived(data):
    """
    Validate derived submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing derived submission...")

    #Validate
    errors = validate_derived(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_derived_json(parsed_data)
