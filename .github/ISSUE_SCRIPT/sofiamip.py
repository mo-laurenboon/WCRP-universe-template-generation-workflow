#!/usr/bin/env python3
"""
Handler for sofiamip submissions.
"""

import json
from pathlib import Path

def validate_sofiamip(data):
    """
    Validate sofiamip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing sofiamip submission...")

    #Validate
    errors = validate_sofiamip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_sofiamip_json(parsed_data)

    #Write file
    output_dir = Path("sofiamip")
