#!/usr/bin/env python3
"""
Handler for ncas submissions.
"""

import json
from pathlib import Path

def validate_ncas(data):
    """
    Validate ncas submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ncas submission...")

    #Validate
    errors = validate_ncas(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ncas_json(parsed_data)

    #Write file
    output_dir = Path("ncas")
