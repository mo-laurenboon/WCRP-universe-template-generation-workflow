#!/usr/bin/env python3
"""
Handler for gr8g submissions.
"""

import json
from pathlib import Path

def validate_gr8g(data):
    """
    Validate gr8g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr8g submission...")

    #Validate
    errors = validate_gr8g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr8g_json(parsed_data)

    #Write file
    output_dir = Path("gr8g")
