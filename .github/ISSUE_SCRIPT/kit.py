...
def run(parsed_data, issue_data):
    ...
    """
    print("processing kit submission...")

    #Validate
    errors = validate_kit(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_kit_json(parsed_data)
