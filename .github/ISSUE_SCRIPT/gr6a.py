#!/usr/bin/env python3
"""
Handler for gr6a submissions.
"""

import json
from pathlib import Path

def validate_gr6a(data):
    """
    Validate gr6a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr6a submission...")

    #Validate
    errors = validate_gr6a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr6a_json(parsed_data)

    #Write file
    output_dir = Path("gr6a")
