#!/usr/bin/env python3
"""
Handler for nicam submissions.
"""

import json
from pathlib import Path

def validate_nicam(data):
    """
    Validate nicam submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nicam submission...")

    #Validate
    errors = validate_nicam(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nicam_json(parsed_data)

    #Write file
    output_dir = Path("nicam")
