#!/usr/bin/env python3
"""
Handler for 1km submissions.
"""

import json
from pathlib import Path

def validate_1km(data):
    """
    Validate 1km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1km submission...")

    #Validate
    errors = validate_1km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1km_json(parsed_data)
