#!/usr/bin/env python3
"""
Handler for rss submissions.
"""

import json
from pathlib import Path

def validate_rss(data):
    """
    Validate rss submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing rss submission...")

    #Validate
    errors = validate_rss(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_rss_json(parsed_data)
