#!/usr/bin/env python3
"""
Handler for hkust submissions.
"""

import json
from pathlib import Path

def validate_hkust(data):
    """
    Validate hkust submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing hkust submission...")

    #Validate
    errors = validate_hkust(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_hkust_json(parsed_data)

    #Write file
    output_dir = Path("hkust")
