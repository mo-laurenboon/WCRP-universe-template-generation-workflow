#!/usr/bin/env python3
"""
Handler for gm submissions.
"""

import json
from pathlib import Path

def validate_gm(data):
    """
    Validate gm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gm submission...")

    #Validate
    errors = validate_gm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gm_json(parsed_data)
