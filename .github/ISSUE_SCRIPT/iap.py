#!/usr/bin/env python3
"""
Handler for iap submissions.
"""

import json
from pathlib import Path

def validate_iap(data):
    """
    Validate iap submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing iap submission...")

    #Validate
    errors = validate_iap(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_iap_json(parsed_data)
