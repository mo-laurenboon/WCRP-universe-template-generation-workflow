#!/usr/bin/env python3
"""
Handler for pnnl-waccem submissions.
"""

import json
from pathlib import Path

def validate_pnnl_waccem(data):
    """
    Validate pnnl-waccem submission.
...
def create_pnnl_waccem_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pnnl-waccem submission...")

    #Validate
    errors = validate_pnnl_waccem(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pnnl_waccem_json(parsed_data)

    #Write file
    output_dir = Path("pnnl-waccem")
