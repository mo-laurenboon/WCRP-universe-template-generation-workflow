#!/usr/bin/env python3
"""
Handler for model_family submissions.
"""
...
def validate_model_family(data):
    """
    Validate model_family submission.
...
def create_model_family_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing model_family submission...")

    #Validate
    errors = validate_model_family(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_model_family_json(parsed_data)

    #Write file
    output_dir = Path("model_family")
