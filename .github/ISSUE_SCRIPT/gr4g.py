#!/usr/bin/env python3
"""
Handler for gr4g submissions.
"""

import json
from pathlib import Path

def validate_gr4g(data):
    """
    Validate gr4g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr4g submission...")

    #Validate
    errors = validate_gr4g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr4g_json(parsed_data)

    #Write file
    output_dir = Path("gr4g")
