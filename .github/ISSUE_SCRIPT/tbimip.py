#!/usr/bin/env python3
"""
Handler for tbimip submissions.
"""

import json
from pathlib import Path

def validate_tbimip(data):
    """
    Validate tbimip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing tbimip submission...")

    #Validate
    errors = validate_tbimip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_tbimip_json(parsed_data)

    #Write file
    output_dir = Path("tbimip")
