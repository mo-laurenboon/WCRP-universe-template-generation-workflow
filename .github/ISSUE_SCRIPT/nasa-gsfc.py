#!/usr/bin/env python3
"""
Handler for nasa-gsfc submissions.
"""

import json
from pathlib import Path

def validate_nasa_gsfc(data):
    """
    Validate nasa-gsfc submission.
...
def create_nasa_gsfc_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nasa-gsfc submission...")

    #Validate
    errors = validate_nasa_gsfc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nasa_gsfc_json(parsed_data)

    #Write file
    output_dir = Path("nasa-gsfc")
