#!/usr/bin/env python3
"""
Handler for ecmwf submissions.
"""

import json
from pathlib import Path

def validate_ecmwf(data):
    """
    Validate ecmwf submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ecmwf submission...")

    #Validate
    errors = validate_ecmwf(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ecmwf_json(parsed_data)

    #Write file
    output_dir = Path("ecmwf")
