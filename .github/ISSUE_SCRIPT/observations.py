#!/usr/bin/env python3
"""
Handler for observations submissions.
"""
...
def validate_observations(data):
    """
    Validate observations submission.
...
def create_observations_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing observations submission...")

    #Validate
    errors = validate_observations(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_observations_json(parsed_data)
