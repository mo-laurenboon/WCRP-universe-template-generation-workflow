#!/usr/bin/env python3
"""
Handler for ism submissions.
"""

import json
from pathlib import Path

def validate_ism(data):
    """
    Validate ism submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ism submission...")

    #Validate
    errors = validate_ism(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ism_json(parsed_data)
