#!/usr/bin/env python3
"""
Handler for 366-day submissions.
"""

import json
from pathlib import Path

def validate_366_day(data):
    """
    Validate 366-day submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 366-day submission...")

    #Validate
    errors = validate_366_day(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_366_day_json(parsed_data)

    #Write file
    output_dir = Path("366-day")
