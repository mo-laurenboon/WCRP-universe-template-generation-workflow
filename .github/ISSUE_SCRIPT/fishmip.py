#!/usr/bin/env python3
"""
Handler for fishmip submissions.
"""

import json
from pathlib import Path

def validate_fishmip(data):
    """
    Validate fishmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fishmip submission...")

    #Validate
    errors = validate_fishmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fishmip_json(parsed_data)

    #Write file
    output_dir = Path("fishmip")
