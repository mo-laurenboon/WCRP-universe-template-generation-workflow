#!/usr/bin/env python3
"""
Handler for atmosphere-sleve-coordinate submissions.
"""

import json
from pathlib import Path

def validate_atmosphere_sleve_coordinate(data):
    """
    Validate atmosphere-sleve-coordinate submission.
...
def create_atmosphere_sleve_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere-sleve-coordinate submission...")

    #Validate
    errors = validate_atmosphere_sleve_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_sleve_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere-sleve-coordinate")
    ...
    return {
        ...
        "category": "atmosphere-sleve-coordinate",
        "id": entry_id
    }