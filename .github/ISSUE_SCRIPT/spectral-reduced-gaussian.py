#!/usr/bin/env python3
"""
Handler for spectral-reduced-gaussian submissions.
"""

import json
from pathlib import Path

def validate_spectral_reduced_gaussian(data):
    """
    Validate spectral-reduced-gaussian submission.
...
def create_spectral_reduced_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing spectral-reduced-gaussian submission...")

    #Validate
    errors = validate_spectral_reduced_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_spectral_reduced_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("spectral-reduced-gaussian")
    ...
    return {
        ...
        "category": "spectral-reduced-gaussian",
        "id": entry_id
    }