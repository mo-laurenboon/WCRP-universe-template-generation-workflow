#!/usr/bin/env python3
"""
Handler for cmip submissions.
"""

import json
from pathlib import Path

def validate_cmip(data):
    """
    Validate cmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmip submission...")

    #Validate
    errors = validate_cmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmip_json(parsed_data)

    #Write file
    output_dir = Path("cmip")
