#!/usr/bin/env python3
"""
Handler for gr1z submissions.
"""

import json
from pathlib import Path

def validate_gr1z(data):
    """
    Validate gr1z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr1z submission...")

    #Validate
    errors = validate_gr1z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr1z_json(parsed_data)

    #Write file
    output_dir = Path("gr1z")
