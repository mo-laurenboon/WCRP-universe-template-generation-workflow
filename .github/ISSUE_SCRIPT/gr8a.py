#!/usr/bin/env python3
"""
Handler for gr8a submissions.
"""

import json
from pathlib import Path

def validate_gr8a(data):
    """
    Validate gr8a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr8a submission...")

    #Validate
    errors = validate_gr8a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr8a_json(parsed_data)

    #Write file
    output_dir = Path("gr8a")
