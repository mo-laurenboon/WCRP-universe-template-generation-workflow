#!/usr/bin/env python3
"""
Handler for bcc-csm submissions.
"""

import json
from pathlib import Path

def validate_bcc_csm(data):
    """
    Validate bcc-csm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing bcc-csm submission...")

    #Validate
    errors = validate_bcc_csm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_bcc_csm_json(parsed_data)

    #Write file
    output_dir = Path("bcc-csm")
