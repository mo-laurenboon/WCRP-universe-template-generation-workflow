#!/usr/bin/env python3
"""
Handler for gr6 submissions.
"""

import json
from pathlib import Path

def validate_gr6(data):
    """
    Validate gr6 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr6 submission...")

    #Validate
    errors = validate_gr6(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr6_json(parsed_data)
