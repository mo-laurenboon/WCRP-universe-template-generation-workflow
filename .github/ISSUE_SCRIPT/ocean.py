#!/usr/bin/env python3
"""
Handler for ocean submissions.
"""

import json
from pathlib import Path

def validate_ocean(data):
    """
    Validate ocean submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocean submission...")

    #Validate
    errors = validate_ocean(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocean_json(parsed_data)

    #Write file
    output_dir = Path("ocean")
