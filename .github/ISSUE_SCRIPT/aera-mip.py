#!/usr/bin/env python3
"""
Handler for aera-mip submissions.
"""

import json
from pathlib import Path

def validate_aera_mip(data):
    """
    Validate aera-mip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aera-mip submission...")

    #Validate
    errors = validate_aera_mip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aera_mip_json(parsed_data)

    #Write file
    output_dir = Path("aera-mip")
