#!/usr/bin/env python3
"""
Handler for ipsl submissions.
"""

import json
from pathlib import Path

def validate_ipsl(data):
    """
    Validate ipsl submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ipsl submission...")

    #Validate
    errors = validate_ipsl(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ipsl_json(parsed_data)

    #Write file
    output_dir = Path("ipsl")
