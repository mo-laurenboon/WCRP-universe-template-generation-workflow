#!/usr/bin/env python3
"""
Handler for awi submissions.
"""

import json
from pathlib import Path

def validate_awi(data):
    """
    Validate awi submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing awi submission...")

    #Validate
    errors = validate_awi(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_awi_json(parsed_data)
