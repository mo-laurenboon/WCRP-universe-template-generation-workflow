#!/usr/bin/env python3
"""
Handler for atmosphere submissions.
"""

import json
from pathlib import Path

def validate_atmosphere(data):
    """
    Validate atmosphere submission.
...
def create_atmosphere_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere submission...")

    #Validate
    errors = validate_atmosphere(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere")
