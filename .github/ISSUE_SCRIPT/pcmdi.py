#!/usr/bin/env python3
"""
Handler for pcmdi submissions.
"""

import json
from pathlib import Path

def validate_pcmdi(data):
    """
    Validate pcmdi submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pcmdi submission...")

    #Validate
    errors = validate_pcmdi(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pcmdi_json(parsed_data)

    #Write file
    output_dir = Path("pcmdi")
