#!/usr/bin/env python3
"""
Handler for gng submissions.
"""

import json
from pathlib import Path

def validate_gng(data):
    """
    Validate gng submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gng submission...")

    #Validate
    errors = validate_gng(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gng_json(parsed_data)
