#!/usr/bin/env python3
"""
Handler for cmip6plus submissions.
"""

import json
from pathlib import Path

def validate_cmip6plus(data):
    """
    Validate cmip6plus submission.
...
def create_cmip6plus_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmip6plus submission...")

    #Validate
    errors = validate_cmip6plus(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmip6plus_json(parsed_data)

    #Write file
    output_dir = Path("cmip6plus")
