#!/usr/bin/env python3
"""
Handler for source_type submissions.
"""
...
def validate_source_type(data):
    """
    Validate source_type submission.
...
def create_source_type_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing source_type submission...")

    #Validate
    errors = validate_source_type(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_source_type_json(parsed_data)

    #Write file
    output_dir = Path("source_type")
