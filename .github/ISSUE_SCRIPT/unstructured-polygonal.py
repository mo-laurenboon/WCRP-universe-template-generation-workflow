#!/usr/bin/env python3
"""
Handler for unstructured-polygonal submissions.
"""

import json
from pathlib import Path

def validate_unstructured_polygonal(data):
    """
    Validate unstructured-polygonal submission.
...
def create_unstructured_polygonal_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing unstructured-polygonal submission...")

    #Validate
    errors = validate_unstructured_polygonal(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_unstructured_polygonal_json(parsed_data)

    #Write file
    output_dir = Path("unstructured-polygonal")
    ...
    return {
        ...
        "category": "unstructured-polygonal",
        "id": entry_id
    }