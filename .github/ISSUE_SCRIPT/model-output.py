#!/usr/bin/env python3
"""
Handler for model-output submissions.
"""
...
def validate_model_output(data):
    """
    Validate model-output submission.
...
def create_model_output_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing model-output submission...")

    #Validate
    errors = validate_model_output(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_model_output_json(parsed_data)
