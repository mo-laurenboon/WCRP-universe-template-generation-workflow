#!/usr/bin/env python3
"""
Handler for 2500km submissions.
"""

import json
from pathlib import Path

def validate_2500km(data):
    """
    Validate 2500km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 2500km submission...")

    #Validate
    errors = validate_2500km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_2500km_json(parsed_data)

    #Write file
    output_dir = Path("2500km")
