#!/usr/bin/env python3
"""
Handler for ismip7 submissions.
"""

import json
from pathlib import Path

def validate_ismip7(data):
    """
    Validate ismip7 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ismip7 submission...")

    #Validate
    errors = validate_ismip7(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ismip7_json(parsed_data)

    #Write file
    output_dir = Path("ismip7")
