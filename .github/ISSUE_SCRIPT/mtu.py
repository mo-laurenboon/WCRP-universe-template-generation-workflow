#!/usr/bin/env python3
"""
Handler for mtu submissions.
"""

import json
from pathlib import Path

def validate_mtu(data):
    """
    Validate mtu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mtu submission...")

    #Validate
    errors = validate_mtu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mtu_json(parsed_data)
