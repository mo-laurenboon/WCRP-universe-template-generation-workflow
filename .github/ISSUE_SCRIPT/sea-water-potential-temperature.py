#!/usr/bin/env python3
"""
Handler for sea-water-potential-temperature submissions.
"""

import json
from pathlib import Path

def validate_sea_water_potential_temperature(data):
    """
    Validate sea-water-potential-temperature submission.
...
def create_sea_water_potential_temperature_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing sea-water-potential-temperature submission...")

    #Validate
    errors = validate_sea_water_potential_temperature(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_sea_water_potential_temperature_json(parsed_data)

    #Write file
    output_dir = Path("sea-water-potential-temperature")
    ...
    return {
        ...
        "category": "sea-water-potential-temperature",
        "id": entry_id
    }