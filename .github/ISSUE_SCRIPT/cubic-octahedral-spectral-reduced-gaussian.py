#!/usr/bin/env python3
"""
Handler for cubic-octahedral-spectral-reduced-gaussian submissions.
"""

import json
from pathlib import Path

def validate_cubic_octahedral_spectral_reduced_gaussian(data):
    """
    Validate cubic-octahedral-spectral-reduced-gaussian submission.
...
def create_cubic_octahedral_spectral_reduced_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cubic-octahedral-spectral-reduced-gaussian submission...")

    #Validate
    errors = validate_cubic_octahedral_spectral_reduced_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cubic_octahedral_spectral_reduced_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("cubic-octahedral-spectral-reduced-gaussian")
    ...
    return {
        ...
        "category": "cubic-octahedral-spectral-reduced-gaussian",
        "id": entry_id
    }