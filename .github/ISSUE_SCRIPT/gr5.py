#!/usr/bin/env python3
"""
Handler for gr5 submissions.
"""

import json
from pathlib import Path

def validate_gr5(data):
    """
    Validate gr5 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr5 submission...")

    #Validate
    errors = validate_gr5(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr5_json(parsed_data)
