#!/usr/bin/env python3
"""
Handler for cubed-sphere submissions.
"""

import json
from pathlib import Path

def validate_cubed_sphere(data):
    """
    Validate cubed-sphere submission.
...
def create_cubed_sphere_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cubed-sphere submission...")

    #Validate
    errors = validate_cubed_sphere(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cubed_sphere_json(parsed_data)

    #Write file
    output_dir = Path("cubed-sphere")
