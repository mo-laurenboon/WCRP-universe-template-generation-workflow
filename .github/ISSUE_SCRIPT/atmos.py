#!/usr/bin/env python3
"""
Handler for atmos submissions.
"""

import json
from pathlib import Path

def validate_atmos(data):
    """
    Validate atmos submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmos submission...")

    #Validate
    errors = validate_atmos(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmos_json(parsed_data)

    #Write file
    output_dir = Path("atmos")
