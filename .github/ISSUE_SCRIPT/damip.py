#!/usr/bin/env python3
"""
Handler for damip submissions.
"""

import json
from pathlib import Path

def validate_damip(data):
    """
    Validate damip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing damip submission...")

    #Validate
    errors = validate_damip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_damip_json(parsed_data)

    #Write file
    output_dir = Path("damip")
