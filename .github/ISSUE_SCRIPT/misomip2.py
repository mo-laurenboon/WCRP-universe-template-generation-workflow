#!/usr/bin/env python3
"""
Handler for misomip2 submissions.
"""

import json
from pathlib import Path

def validate_misomip2(data):
    """
    Validate misomip2 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing misomip2 submission...")

    #Validate
    errors = validate_misomip2(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_misomip2_json(parsed_data)

    #Write file
    output_dir = Path("misomip2")
