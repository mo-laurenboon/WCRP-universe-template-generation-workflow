#!/usr/bin/env python3
"""
Handler for none submissions.
"""

import json
from pathlib import Path

def validate_none(data):
    """
    Validate none submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing none submission...")

    #Validate
    errors = validate_none(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_none_json(parsed_data)
