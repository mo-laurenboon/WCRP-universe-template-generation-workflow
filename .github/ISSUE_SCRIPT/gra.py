#!/usr/bin/env python3
"""
Handler for gra submissions.
"""

import json
from pathlib import Path

def validate_gra(data):
    """
    Validate gra submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gra submission...")

    #Validate
    errors = validate_gra(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gra_json(parsed_data)
