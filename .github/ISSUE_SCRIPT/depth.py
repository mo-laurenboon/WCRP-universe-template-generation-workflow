...
def run(parsed_data, issue_data):
    ...
    """
    print("processing depth submission...")

    #Validate
    errors = validate_depth(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_depth_json(parsed_data)

    #Write file
    output_dir = Path("depth")
