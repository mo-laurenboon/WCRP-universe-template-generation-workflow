#!/usr/bin/env python3
"""
Handler for reduced-gaussian submissions.
"""

import json
from pathlib import Path

def validate_reduced_gaussian(data):
    """
    Validate reduced-gaussian submission.
...
def create_reduced_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing reduced-gaussian submission...")

    #Validate
    errors = validate_reduced_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_reduced_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("reduced-gaussian")
