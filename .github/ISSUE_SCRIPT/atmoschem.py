#!/usr/bin/env python3
"""
Handler for atmoschem submissions.
"""

import json
from pathlib import Path

def validate_atmoschem(data):
    """
    Validate atmoschem submission.
...
def create_atmoschem_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmoschem submission...")

    #Validate
    errors = validate_atmoschem(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmoschem_json(parsed_data)

    #Write file
    output_dir = Path("atmoschem")
