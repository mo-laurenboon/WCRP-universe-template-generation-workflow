#!/usr/bin/env python3
"""
Handler for dcpp submissions.
"""

import json
from pathlib import Path

def validate_dcpp(data):
    """
    Validate dcpp submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing dcpp submission...")

    #Validate
    errors = validate_dcpp(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_dcpp_json(parsed_data)

    #Write file
    output_dir = Path("dcpp")
