#!/usr/bin/env python3
"""
Handler for access submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing access submission...")

    #Validate
    errors = validate_access(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_access_json(parsed_data)

    #Write file
    output_dir = Path("access")
