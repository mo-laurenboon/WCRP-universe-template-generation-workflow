#!/usr/bin/env python3
"""
Handler for regular-gaussian submissions.
"""

import json
from pathlib import Path

def validate_regular_gaussian(data):
    """
    Validate regular-gaussian submission.
...
def create_regular_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing regular-gaussian submission...")

    #Validate
    errors = validate_regular_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_regular_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("regular-gaussian")
