#!/usr/bin/env python3
"""
Handler for global submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing global submission...")

    #Validate
    errors = validate_global(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_global_json(parsed_data)

    #Write file
    output_dir = Path("global")
