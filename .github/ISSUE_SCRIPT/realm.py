#!/usr/bin/env python3
"""
Handler for realm submissions.
"""

import json
from pathlib import Path

def validate_realm(data):
    """
    Validate realm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing realm submission...")

    #Validate
    errors = validate_realm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_realm_json(parsed_data)

    #Write file
    output_dir = Path("realm")
