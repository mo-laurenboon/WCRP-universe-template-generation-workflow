#!/usr/bin/env python3
"""
Handler for gr2 submissions.
"""

import json
from pathlib import Path

def validate_gr2(data):
    """
    Validate gr2 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr2 submission...")

    #Validate
    errors = validate_gr2(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr2_json(parsed_data)
