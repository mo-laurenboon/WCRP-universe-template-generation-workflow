#!/usr/bin/env python3
"""
Handler for atmosphere-hybrid-sigma-pressure-coordinate submissions.
"""

import json
from pathlib import Path

def validate_atmosphere_hybrid_sigma_pressure_coordinate(data):
    """
    Validate atmosphere-hybrid-sigma-pressure-coordinate submission.
...
def create_atmosphere_hybrid_sigma_pressure_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere-hybrid-sigma-pressure-coordinate submission...")

    #Validate
    errors = validate_atmosphere_hybrid_sigma_pressure_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_hybrid_sigma_pressure_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere-hybrid-sigma-pressure-coordinate")
    ...
    return {
        ...
        "category": "atmosphere-hybrid-sigma-pressure-coordinate",
        "id": entry_id
    }