#!/usr/bin/env python3
"""
Handler for 1hrpt submissions.
"""

import json
from pathlib import Path

def validate_1hrpt(data):
    """
    Validate 1hrpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1hrpt submission...")

    #Validate
    errors = validate_1hrpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1hrpt_json(parsed_data)

    #Write file
    output_dir = Path("1hrpt")
