#!/usr/bin/env python3
"""
Handler for fgoals submissions.
"""

import json
from pathlib import Path

def validate_fgoals(data):
    """
    Validate fgoals submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fgoals submission...")

    #Validate
    errors = validate_fgoals(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fgoals_json(parsed_data)

    #Write file
    output_dir = Path("fgoals")
