#!/usr/bin/env python3
"""
Handler for cmip6 submissions.
"""

import json
from pathlib import Path

def validate_cmip6(data):
    """
    Validate cmip6 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmip6 submission...")

    #Validate
    errors = validate_cmip6(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmip6_json(parsed_data)

    #Write file
    output_dir = Path("cmip6")
