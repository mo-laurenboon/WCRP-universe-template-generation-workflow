#!/usr/bin/env python3
"""
Handler for dec submissions.
"""

import json
from pathlib import Path

def validate_dec(data):
    """
    Validate dec submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing dec submission...")

    #Validate
    errors = validate_dec(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_dec_json(parsed_data)
