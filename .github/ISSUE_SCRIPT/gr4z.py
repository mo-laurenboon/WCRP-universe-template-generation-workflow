#!/usr/bin/env python3
"""
Handler for gr4z submissions.
"""

import json
from pathlib import Path

def validate_gr4z(data):
    """
    Validate gr4z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr4z submission...")

    #Validate
    errors = validate_gr4z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr4z_json(parsed_data)

    #Write file
    output_dir = Path("gr4z")
