#!/usr/bin/env python3
"""
Handler for aerosol submissions.
"""

import json
from pathlib import Path

def validate_aerosol(data):
    """
    Validate aerosol submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aerosol submission...")

    #Validate
    errors = validate_aerosol(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aerosol_json(parsed_data)

    #Write file
    output_dir = Path("aerosol")
