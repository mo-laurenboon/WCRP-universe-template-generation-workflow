#!/usr/bin/env python3
"""
Handler for land submissions.
"""

import json
from pathlib import Path

def validate_land(data):
    """
    Validate land submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing land submission...")

    #Validate
    errors = validate_land(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_land_json(parsed_data)

    #Write file
    output_dir = Path("land")
