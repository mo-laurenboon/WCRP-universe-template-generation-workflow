#!/usr/bin/env python3
"""
Handler for gr1 submissions.
"""

import json
from pathlib import Path

def validate_gr1(data):
    """
    Validate gr1 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr1 submission...")

    #Validate
    errors = validate_gr1(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr1_json(parsed_data)
