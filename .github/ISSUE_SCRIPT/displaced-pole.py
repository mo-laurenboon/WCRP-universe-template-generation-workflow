#!/usr/bin/env python3
"""
Handler for displaced-pole submissions.
"""

import json
from pathlib import Path

def validate_displaced_pole(data):
    """
    Validate displaced-pole submission.
...
def create_displaced_pole_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing displaced-pole submission...")

    #Validate
    errors = validate_displaced_pole(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_displaced_pole_json(parsed_data)

    #Write file
    output_dir = Path("displaced-pole")
