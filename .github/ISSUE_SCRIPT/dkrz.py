#!/usr/bin/env python3
"""
Handler for dkrz submissions.
"""

import json
from pathlib import Path

def validate_dkrz(data):
    """
    Validate dkrz submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing dkrz submission...")

    #Validate
    errors = validate_dkrz(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_dkrz_json(parsed_data)

    #Write file
    output_dir = Path("dkrz")
