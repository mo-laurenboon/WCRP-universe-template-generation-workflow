#!/usr/bin/env python3
"""
Handler for imperialcollege submissions.
"""

import json
from pathlib import Path

def validate_imperialcollege(data):
    """
    Validate imperialcollege submission.
...
def create_imperialcollege_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing imperialcollege submission...")

    #Validate
    errors = validate_imperialcollege(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_imperialcollege_json(parsed_data)

    #Write file
    output_dir = Path("imperialcollege")
