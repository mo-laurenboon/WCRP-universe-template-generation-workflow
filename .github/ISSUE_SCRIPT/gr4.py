#!/usr/bin/env python3
"""
Handler for gr4 submissions.
"""

import json
from pathlib import Path

def validate_gr4(data):
    """
    Validate gr4 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr4 submission...")

    #Validate
    errors = validate_gr4(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr4_json(parsed_data)
