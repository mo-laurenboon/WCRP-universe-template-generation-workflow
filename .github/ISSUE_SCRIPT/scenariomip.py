#!/usr/bin/env python3
"""
Handler for scenariomip submissions.
"""

import json
from pathlib import Path

def validate_scenariomip(data):
    """
    Validate scenariomip submission.
...
def create_scenariomip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing scenariomip submission...")

    #Validate
    errors = validate_scenariomip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_scenariomip_json(parsed_data)

    #Write file
    output_dir = Path("scenariomip")
