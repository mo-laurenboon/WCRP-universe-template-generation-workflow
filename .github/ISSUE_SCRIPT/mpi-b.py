#!/usr/bin/env python3
"""
Handler for mpi-b submissions.
"""

import json
from pathlib import Path

def validate_mpi_b(data):
    """
    Validate mpi-b submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mpi-b submission...")

    #Validate
    errors = validate_mpi_b(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mpi_b_json(parsed_data)

    #Write file
    output_dir = Path("mpi-b")
