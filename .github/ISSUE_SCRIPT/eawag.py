#!/usr/bin/env python3
"""
Handler for eawag submissions.
"""

import json
from pathlib import Path

def validate_eawag(data):
    """
    Validate eawag submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing eawag submission...")

    #Validate
    errors = validate_eawag(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_eawag_json(parsed_data)

    #Write file
    output_dir = Path("eawag")
