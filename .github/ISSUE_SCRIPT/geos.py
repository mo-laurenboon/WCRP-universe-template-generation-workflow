#!/usr/bin/env python3
"""
Handler for geos submissions.
"""

import json
from pathlib import Path

def validate_geos(data):
    """
    Validate geos submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing geos submission...")

    #Validate
    errors = validate_geos(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_geos_json(parsed_data)

    #Write file
    output_dir = Path("geos")
