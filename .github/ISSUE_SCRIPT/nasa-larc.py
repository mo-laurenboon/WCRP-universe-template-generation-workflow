#!/usr/bin/env python3
"""
Handler for nasa-larc submissions.
"""

import json
from pathlib import Path

def validate_nasa_larc(data):
    """
    Validate nasa-larc submission.
...
def create_nasa_larc_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nasa-larc submission...")

    #Validate
    errors = validate_nasa_larc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nasa_larc_json(parsed_data)

    #Write file
    output_dir = Path("nasa-larc")
