#!/usr/bin/env python3
"""
Handler for cnrm-cm submissions.
"""

import json
from pathlib import Path

def validate_cnrm_cm(data):
    """
    Validate cnrm-cm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cnrm-cm submission...")

    #Validate
    errors = validate_cnrm_cm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cnrm_cm_json(parsed_data)

    #Write file
    output_dir = Path("cnrm-cm")
