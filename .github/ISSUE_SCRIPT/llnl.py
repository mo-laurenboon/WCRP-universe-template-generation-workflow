#!/usr/bin/env python3
"""
Handler for llnl submissions.
"""

import json
from pathlib import Path

def validate_llnl(data):
    """
    Validate llnl submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing llnl submission...")

    #Validate
    errors = validate_llnl(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_llnl_json(parsed_data)

    #Write file
    output_dir = Path("llnl")
