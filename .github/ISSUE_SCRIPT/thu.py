#!/usr/bin/env python3
"""
Handler for thu submissions.
"""

import json
from pathlib import Path

def validate_thu(data):
    """
    Validate thu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing thu submission...")

    #Validate
    errors = validate_thu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_thu_json(parsed_data)
