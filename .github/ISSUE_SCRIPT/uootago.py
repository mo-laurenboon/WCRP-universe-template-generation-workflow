#!/usr/bin/env python3
"""
Handler for uootago submissions.
"""

import json
from pathlib import Path

def validate_uootago(data):
    """
    Validate uootago submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uootago submission...")

    #Validate
    errors = validate_uootago(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uootago_json(parsed_data)

    #Write file
    output_dir = Path("uootago")
