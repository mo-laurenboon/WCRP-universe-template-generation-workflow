#!/usr/bin/env python3
"""
Handler for monc submissions.
"""

import json
from pathlib import Path

def validate_monc(data):
    """
    Validate monc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing monc submission...")

    #Validate
    errors = validate_monc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_monc_json(parsed_data)

    #Write file
    output_dir = Path("monc")
