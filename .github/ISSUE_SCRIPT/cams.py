#!/usr/bin/env python3
"""
Handler for cams submissions.
"""

import json
from pathlib import Path

def validate_cams(data):
    """
    Validate cams submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cams submission...")

    #Validate
    errors = validate_cams(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cams_json(parsed_data)

    #Write file
    output_dir = Path("cams")
