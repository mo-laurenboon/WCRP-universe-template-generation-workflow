#!/usr/bin/env python3
"""
Handler for lesfmip submissions.
"""

import json
from pathlib import Path

def validate_lesfmip(data):
    """
    Validate lesfmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing lesfmip submission...")

    #Validate
    errors = validate_lesfmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_lesfmip_json(parsed_data)

    #Write file
    output_dir = Path("lesfmip")
