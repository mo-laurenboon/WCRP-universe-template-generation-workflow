#!/usr/bin/env python3
"""
Handler for atmosphere-hybrid-height-coordinate submissions.
"""

import json
from pathlib import Path

def validate_atmosphere_hybrid_height_coordinate(data):
    """
    Validate atmosphere-hybrid-height-coordinate submission.
...
def create_atmosphere_hybrid_height_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere-hybrid-height-coordinate submission...")

    #Validate
    errors = validate_atmosphere_hybrid_height_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_hybrid_height_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere-hybrid-height-coordinate")
    ...
    return {
        ...
        "category": "atmosphere-hybrid-height-coordinate",
        "id": entry_id
    }