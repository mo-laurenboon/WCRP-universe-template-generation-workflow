#!/usr/bin/env python3
"""
Handler for 50km submissions.
"""

import json
from pathlib import Path

def validate_50km(data):
    """
    Validate 50km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 50km submission...")

    #Validate
    errors = validate_50km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_50km_json(parsed_data)

    #Write file
    output_dir = Path("50km")
