#!/usr/bin/env python3
"""
Handler for fuberlin submissions.
"""

import json
from pathlib import Path

def validate_fuberlin(data):
    """
    Validate fuberlin submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fuberlin submission...")

    #Validate
    errors = validate_fuberlin(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fuberlin_json(parsed_data)

    #Write file
    output_dir = Path("fuberlin")
