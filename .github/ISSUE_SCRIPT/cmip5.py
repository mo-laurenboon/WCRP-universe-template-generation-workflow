#!/usr/bin/env python3
"""
Handler for cmip5 submissions.
"""

import json
from pathlib import Path

def validate_cmip5(data):
    """
    Validate cmip5 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmip5 submission...")

    #Validate
    errors = validate_cmip5(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmip5_json(parsed_data)

    #Write file
    output_dir = Path("cmip5")
