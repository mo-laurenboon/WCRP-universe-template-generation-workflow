#!/usr/bin/env python3
"""
Handler for c4mip submissions.
"""

import json
from pathlib import Path

def validate_c4mip(data):
    """
    Validate c4mip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing c4mip submission...")

    #Validate
    errors = validate_c4mip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_c4mip_json(parsed_data)

    #Write file
    output_dir = Path("c4mip")
