#!/usr/bin/env python3
"""
Handler for aerchemmip2 submissions.
"""

import json
from pathlib import Path

def validate_aerchemmip2(data):
    """
    Validate aerchemmip2 submission.
...
def create_aerchemmip2_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aerchemmip2 submission...")

    #Validate
    errors = validate_aerchemmip2(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aerchemmip2_json(parsed_data)

    #Write file
    output_dir = Path("aerchemmip2")
