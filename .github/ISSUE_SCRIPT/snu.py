#!/usr/bin/env python3
"""
Handler for snu submissions.
"""

import json
from pathlib import Path

def validate_snu(data):
    """
    Validate snu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing snu submission...")

    #Validate
    errors = validate_snu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_snu_json(parsed_data)
