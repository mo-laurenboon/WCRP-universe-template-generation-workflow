#!/usr/bin/env python3
"""
Handler for height submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing height submission...")

    #Validate
    errors = validate_height(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_height_json(parsed_data)

    #Write file
    output_dir = Path("height")
