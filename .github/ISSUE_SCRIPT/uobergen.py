#!/usr/bin/env python3
"""
Handler for uobergen submissions.
"""

import json
from pathlib import Path

def validate_uobergen(data):
    """
    Validate uobergen submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uobergen submission...")

    #Validate
    errors = validate_uobergen(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uobergen_json(parsed_data)

    #Write file
    output_dir = Path("uobergen")
