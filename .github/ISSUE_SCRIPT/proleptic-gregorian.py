#!/usr/bin/env python3
"""
Handler for proleptic-gregorian submissions.
"""

import json
from pathlib import Path

def validate_proleptic_gregorian(data):
    """
    Validate proleptic-gregorian submission.
...
def create_proleptic_gregorian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing proleptic-gregorian submission...")

    #Validate
    errors = validate_proleptic_gregorian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_proleptic_gregorian_json(parsed_data)

    #Write file
    output_dir = Path("proleptic-gregorian")
