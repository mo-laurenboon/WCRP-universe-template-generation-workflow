#!/usr/bin/env python3
"""
Handler for 6hrpt submissions.
"""

import json
from pathlib import Path

def validate_6hrpt(data):
    """
    Validate 6hrpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 6hrpt submission...")

    #Validate
    errors = validate_6hrpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_6hrpt_json(parsed_data)

    #Write file
    output_dir = Path("6hrpt")
