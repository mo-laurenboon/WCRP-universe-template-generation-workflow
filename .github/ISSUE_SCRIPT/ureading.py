#!/usr/bin/env python3
"""
Handler for ureading submissions.
"""

import json
from pathlib import Path

def validate_ureading(data):
    """
    Validate ureading submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ureading submission...")

    #Validate
    errors = validate_ureading(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ureading_json(parsed_data)

    #Write file
    output_dir = Path("ureading")
