...
def run(parsed_data, issue_data):
    ...
    """
    print("processing icon submission...")

    #Validate
    errors = validate_icon(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_icon_json(parsed_data)

    #Write file
    output_dir = Path("icon")
