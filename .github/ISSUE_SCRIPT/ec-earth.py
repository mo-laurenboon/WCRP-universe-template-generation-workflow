#!/usr/bin/env python3
"""
Handler for ec-earth submissions.
"""

import json
from pathlib import Path

def validate_ec_earth(data):
    """
    Validate ec-earth submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ec-earth submission...")

    #Validate
    errors = validate_ec_earth(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ec_earth_json(parsed_data)

    #Write file
    output_dir = Path("ec-earth")
