#!/usr/bin/env python3
"""
Handler for uw submissions.
"""

import json
from pathlib import Path

def validate_uw(data):
    """
    Validate uw submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uw submission...")

    #Validate
    errors = validate_uw(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uw_json(parsed_data)
