#!/usr/bin/env python3
"""
Handler for 3hr submissions.
"""

import json
from pathlib import Path

def validate_3hr(data):
    """
    Validate 3hr submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 3hr submission...")

    #Validate
    errors = validate_3hr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_3hr_json(parsed_data)
