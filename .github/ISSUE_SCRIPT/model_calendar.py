#!/usr/bin/env python3
"""
Handler for model_calendar submissions.
"""
...
def validate_model_calendar(data):
    """
    Validate model_calendar submission.
...
def create_model_calendar_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing model_calendar submission...")

    #Validate
    errors = validate_model_calendar(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_model_calendar_json(parsed_data)

    #Write file
    output_dir = Path("model_calendar")
