#!/usr/bin/env python3
"""
Handler for gr9z submissions.
"""

import json
from pathlib import Path

def validate_gr9z(data):
    """
    Validate gr9z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr9z submission...")

    #Validate
    errors = validate_gr9z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr9z_json(parsed_data)

    #Write file
    output_dir = Path("gr9z")
