#!/usr/bin/env python3
"""
Handler for yin-yang submissions.
"""

import json
from pathlib import Path

def validate_yin_yang(data):
    """
    Validate yin-yang submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing yin-yang submission...")

    #Validate
    errors = validate_yin_yang(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_yin_yang_json(parsed_data)

    #Write file
    output_dir = Path("yin-yang")
