#!/usr/bin/env python3
"""
Handler for rfmip submissions.
"""

import json
from pathlib import Path

def validate_rfmip(data):
    """
    Validate rfmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing rfmip submission...")

    #Validate
    errors = validate_rfmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_rfmip_json(parsed_data)

    #Write file
    output_dir = Path("rfmip")
