#!/usr/bin/env python3
"""
Handler for inm submissions.
"""

import json
from pathlib import Path

def validate_inm(data):
    """
    Validate inm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing inm submission...")

    #Validate
    errors = validate_inm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_inm_json(parsed_data)
