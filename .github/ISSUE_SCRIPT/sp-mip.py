#!/usr/bin/env python3
"""
Handler for sp-mip submissions.
"""

import json
from pathlib import Path

def validate_sp_mip(data):
    """
    Validate sp-mip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing sp-mip submission...")

    #Validate
    errors = validate_sp_mip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_sp_mip_json(parsed_data)

    #Write file
    output_dir = Path("sp-mip")
