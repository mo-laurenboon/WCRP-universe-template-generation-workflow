#!/usr/bin/env python3
"""
Handler for gr9g submissions.
"""

import json
from pathlib import Path

def validate_gr9g(data):
    """
    Validate gr9g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr9g submission...")

    #Validate
    errors = validate_gr9g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr9g_json(parsed_data)

    #Write file
    output_dir = Path("gr9g")
