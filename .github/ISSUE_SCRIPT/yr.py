#!/usr/bin/env python3
"""
Handler for yr submissions.
"""

import json
from pathlib import Path

def validate_yr(data):
    """
    Validate yr submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing yr submission...")

    #Validate
    errors = validate_yr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_yr_json(parsed_data)
