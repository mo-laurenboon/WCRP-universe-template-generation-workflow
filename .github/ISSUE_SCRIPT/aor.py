#!/usr/bin/env python3
"""
Handler for aor submissions.
"""

import json
from pathlib import Path

def validate_aor(data):
    """
    Validate aor submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aor submission...")

    #Validate
    errors = validate_aor(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aor_json(parsed_data)
