#!/usr/bin/env python3
"""
Handler for uofmd submissions.
"""

import json
from pathlib import Path

def validate_uofmd(data):
    """
    Validate uofmd submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uofmd submission...")

    #Validate
    errors = validate_uofmd(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uofmd_json(parsed_data)

    #Write file
    output_dir = Path("uofmd")
