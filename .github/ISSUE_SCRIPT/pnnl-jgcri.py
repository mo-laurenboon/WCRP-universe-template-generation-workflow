#!/usr/bin/env python3
"""
Handler for pnnl-jgcri submissions.
"""

import json
from pathlib import Path

def validate_pnnl_jgcri(data):
    """
    Validate pnnl-jgcri submission.
...
def create_pnnl_jgcri_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pnnl-jgcri submission...")

    #Validate
    errors = validate_pnnl_jgcri(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pnnl_jgcri_json(parsed_data)

    #Write file
    output_dir = Path("pnnl-jgcri")
