#!/usr/bin/env python3
"""
Handler for irrmip submissions.
"""

import json
from pathlib import Path

def validate_irrmip(data):
    """
    Validate irrmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing irrmip submission...")

    #Validate
    errors = validate_irrmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_irrmip_json(parsed_data)

    #Write file
    output_dir = Path("irrmip")
