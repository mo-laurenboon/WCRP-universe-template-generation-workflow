#!/usr/bin/env python3
"""
Handler for ppemip submissions.
"""

import json
from pathlib import Path

def validate_ppemip(data):
    """
    Validate ppemip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ppemip submission...")

    #Validate
    errors = validate_ppemip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ppemip_json(parsed_data)

    #Write file
    output_dir = Path("ppemip")
