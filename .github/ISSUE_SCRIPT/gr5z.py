#!/usr/bin/env python3
"""
Handler for gr5z submissions.
"""

import json
from pathlib import Path

def validate_gr5z(data):
    """
    Validate gr5z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr5z submission...")

    #Validate
    errors = validate_gr5z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr5z_json(parsed_data)

    #Write file
    output_dir = Path("gr5z")
