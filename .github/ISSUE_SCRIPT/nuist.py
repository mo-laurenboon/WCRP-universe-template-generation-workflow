#!/usr/bin/env python3
"""
Handler for nuist submissions.
"""

import json
from pathlib import Path

def validate_nuist(data):
    """
    Validate nuist submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nuist submission...")

    #Validate
    errors = validate_nuist(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nuist_json(parsed_data)

    #Write file
    output_dir = Path("nuist")
