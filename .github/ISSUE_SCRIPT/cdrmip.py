#!/usr/bin/env python3
"""
Handler for cdrmip submissions.
"""

import json
from pathlib import Path

def validate_cdrmip(data):
    """
    Validate cdrmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cdrmip submission...")

    #Validate
    errors = validate_cdrmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cdrmip_json(parsed_data)

    #Write file
    output_dir = Path("cdrmip")
