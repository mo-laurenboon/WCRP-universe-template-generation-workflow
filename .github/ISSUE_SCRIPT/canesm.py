#!/usr/bin/env python3
"""
Handler for canesm submissions.
"""

import json
from pathlib import Path

def validate_canesm(data):
    """
    Validate canesm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing canesm submission...")

    #Validate
    errors = validate_canesm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_canesm_json(parsed_data)

    #Write file
    output_dir = Path("canesm")
