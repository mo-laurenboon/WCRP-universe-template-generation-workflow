#!/usr/bin/env python3
"""
Handler for rad submissions.
"""

import json
from pathlib import Path

def validate_rad(data):
    """
    Validate rad submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing rad submission...")

    #Validate
    errors = validate_rad(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_rad_json(parsed_data)
