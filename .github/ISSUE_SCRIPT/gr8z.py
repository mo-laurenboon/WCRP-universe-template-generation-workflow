#!/usr/bin/env python3
"""
Handler for gr8z submissions.
"""

import json
from pathlib import Path

def validate_gr8z(data):
    """
    Validate gr8z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr8z submission...")

    #Validate
    errors = validate_gr8z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr8z_json(parsed_data)

    #Write file
    output_dir = Path("gr8z")
