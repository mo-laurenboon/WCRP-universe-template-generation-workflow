#!/usr/bin/env python3
"""
Handler for atmosphere-sigma-coordinate submissions.
"""

import json
from pathlib import Path

def validate_atmosphere_sigma_coordinate(data):
    """
    Validate atmosphere-sigma-coordinate submission.
...
def create_atmosphere_sigma_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere-sigma-coordinate submission...")

    #Validate
    errors = validate_atmosphere_sigma_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_sigma_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere-sigma-coordinate")
    ...
    return {
        ...
        "category": "atmosphere-sigma-coordinate",
        "id": entry_id
    }