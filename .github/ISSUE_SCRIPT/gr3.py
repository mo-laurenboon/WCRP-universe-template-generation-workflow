#!/usr/bin/env python3
"""
Handler for gr3 submissions.
"""

import json
from pathlib import Path

def validate_gr3(data):
    """
    Validate gr3 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr3 submission...")

    #Validate
    errors = validate_gr3(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr3_json(parsed_data)
