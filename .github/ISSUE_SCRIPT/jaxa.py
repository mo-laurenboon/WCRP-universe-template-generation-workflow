#!/usr/bin/env python3
"""
Handler for jaxa submissions.
"""

import json
from pathlib import Path

def validate_jaxa(data):
    """
    Validate jaxa submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing jaxa submission...")

    #Validate
    errors = validate_jaxa(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_jaxa_json(parsed_data)

    #Write file
    output_dir = Path("jaxa")
