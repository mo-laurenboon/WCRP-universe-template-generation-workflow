#!/usr/bin/env python3
"""
Handler for resolution submissions.
"""
...
def validate_resolution(data):
    """
    Validate resolution submission.
...
def create_resolution_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing resolution submission...")

    #Validate
    errors = validate_resolution(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_resolution_json(parsed_data)

    #Write file
    output_dir = Path("resolution")
