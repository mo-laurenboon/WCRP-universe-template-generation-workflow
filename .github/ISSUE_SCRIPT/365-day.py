#!/usr/bin/env python3
"""
Handler for 365-day submissions.
"""

import json
from pathlib import Path

def validate_365_day(data):
    """
    Validate 365-day submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 365-day submission...")

    #Validate
    errors = validate_365_day(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_365_day_json(parsed_data)

    #Write file
    output_dir = Path("365-day")
