#!/usr/bin/env python3
"""
Handler for dwd submissions.
"""

import json
from pathlib import Path

def validate_dwd(data):
    """
    Validate dwd submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing dwd submission...")

    #Validate
    errors = validate_dwd(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_dwd_json(parsed_data)
