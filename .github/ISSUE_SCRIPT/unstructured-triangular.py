#!/usr/bin/env python3
"""
Handler for unstructured-triangular submissions.
"""

import json
from pathlib import Path

def validate_unstructured_triangular(data):
    """
    Validate unstructured-triangular submission.
...
def create_unstructured_triangular_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing unstructured-triangular submission...")

    #Validate
    errors = validate_unstructured_triangular(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_unstructured_triangular_json(parsed_data)

    #Write file
    output_dir = Path("unstructured-triangular")
    ...
    return {
        ...
        "category": "unstructured-triangular",
        "id": entry_id
    }