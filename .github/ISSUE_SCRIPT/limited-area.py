#!/usr/bin/env python3
"""
Handler for limited-area submissions.
"""

import json
from pathlib import Path

def validate_limited_area(data):
    """
    Validate limited-area submission.
...
def create_limited_area_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing limited-area submission...")

    #Validate
    errors = validate_limited_area(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_limited_area_json(parsed_data)

    #Write file
    output_dir = Path("limited-area")
