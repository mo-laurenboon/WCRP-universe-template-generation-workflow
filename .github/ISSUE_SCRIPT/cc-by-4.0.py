#!/usr/bin/env python3
"""
Handler for cc-by-4.0 submissions.
"""

import json
from pathlib import Path

def validate_cc_by_4.0(data):
    """
    Validate cc-by-4.0 submission.
...
def create_cc_by_4.0_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cc-by-4.0 submission...")

    #Validate
    errors = validate_cc_by_4.0(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cc_by_4.0_json(parsed_data)

    #Write file
    output_dir = Path("cc-by-4.0")
