#!/usr/bin/env python3
"""
Handler for air-pressure submissions.
"""

import json
from pathlib import Path

def validate_air_pressure(data):
    """
    Validate air-pressure submission.
...
def create_air_pressure_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing air-pressure submission...")

    #Validate
    errors = validate_air_pressure(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_air_pressure_json(parsed_data)

    #Write file
    output_dir = Path("air-pressure")
