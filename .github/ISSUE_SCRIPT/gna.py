#!/usr/bin/env python3
"""
Handler for gna submissions.
"""

import json
from pathlib import Path

def validate_gna(data):
    """
    Validate gna submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gna submission...")

    #Validate
    errors = validate_gna(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gna_json(parsed_data)
