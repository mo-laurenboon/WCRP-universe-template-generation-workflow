#!/usr/bin/env python3
"""
Handler for standard submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing standard submission...")

    #Validate
    errors = validate_standard(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_standard_json(parsed_data)

    #Write file
    output_dir = Path("standard")
