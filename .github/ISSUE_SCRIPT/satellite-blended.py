#!/usr/bin/env python3
"""
Handler for satellite-blended submissions.
"""

import json
from pathlib import Path

def validate_satellite_blended(data):
    """
    Validate satellite-blended submission.
...
def create_satellite_blended_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing satellite-blended submission...")

    #Validate
    errors = validate_satellite_blended(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_satellite_blended_json(parsed_data)

    #Write file
    output_dir = Path("satellite-blended")
