#!/usr/bin/env python3
"""
Handler for 100km submissions.
"""

import json
from pathlib import Path

def validate_100km(data):
    """
    Validate 100km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 100km submission...")

    #Validate
    errors = validate_100km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_100km_json(parsed_data)

    #Write file
    output_dir = Path("100km")
