#!/usr/bin/env python3
"""
Handler for nasa-giss submissions.
"""

import json
from pathlib import Path

def validate_nasa_giss(data):
    """
    Validate nasa-giss submission.
...
def create_nasa_giss_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nasa-giss submission...")

    #Validate
    errors = validate_nasa_giss(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nasa_giss_json(parsed_data)

    #Write file
    output_dir = Path("nasa-giss")
