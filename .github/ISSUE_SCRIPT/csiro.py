#!/usr/bin/env python3
"""
Handler for csiro submissions.
"""

import json
from pathlib import Path

def validate_csiro(data):
    """
    Validate csiro submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing csiro submission...")

    #Validate
    errors = validate_csiro(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_csiro_json(parsed_data)

    #Write file
    output_dir = Path("csiro")
