#!/usr/bin/env python3
"""
Handler for gr9 submissions.
"""

import json
from pathlib import Path

def validate_gr9(data):
    """
    Validate gr9 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr9 submission...")

    #Validate
    errors = validate_gr9(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr9_json(parsed_data)
