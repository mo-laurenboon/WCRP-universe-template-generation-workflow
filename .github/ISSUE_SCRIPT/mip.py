...
def validate_mip(data):
    """
    Validate mip submission.
...
def run(parsed_data):
    ...
    """
    print("processing mip submission...")

    #Validate
    errors = validate_mip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mip_json(parsed_data)
