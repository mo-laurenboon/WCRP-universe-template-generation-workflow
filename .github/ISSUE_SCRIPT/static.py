#!/usr/bin/env python3
"""
Handler for static submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing static submission...")

    #Validate
    errors = validate_static(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_static_json(parsed_data)
