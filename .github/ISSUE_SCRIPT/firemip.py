#!/usr/bin/env python3
"""
Handler for firemip submissions.
"""

import json
from pathlib import Path

def validate_firemip(data):
    """
    Validate firemip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing firemip submission...")

    #Validate
    errors = validate_firemip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_firemip_json(parsed_data)

    #Write file
    output_dir = Path("firemip")
