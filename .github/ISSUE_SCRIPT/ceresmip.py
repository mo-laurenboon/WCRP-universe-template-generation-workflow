#!/usr/bin/env python3
"""
Handler for ceresmip submissions.
"""

import json
from pathlib import Path

def validate_ceresmip(data):
    """
    Validate ceresmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ceresmip submission...")

    #Validate
    errors = validate_ceresmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ceresmip_json(parsed_data)

    #Write file
    output_dir = Path("ceresmip")
