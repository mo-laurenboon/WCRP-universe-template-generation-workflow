#!/usr/bin/env python3
"""
Handler for 2.5km submissions.
"""

import json
from pathlib import Path

def validate_2.5km(data):
    """
    Validate 2.5km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 2.5km submission...")

    #Validate
    errors = validate_2.5km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_2.5km_json(parsed_data)

    #Write file
    output_dir = Path("2.5km")
