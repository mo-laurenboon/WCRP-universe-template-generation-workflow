#!/usr/bin/env python3
"""
Handler for icosahedral-geodesic-dual submissions.
"""

import json
from pathlib import Path

def validate_icosahedral_geodesic_dual(data):
    """
    Validate icosahedral-geodesic-dual submission.
...
def create_icosahedral_geodesic_dual_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing icosahedral-geodesic-dual submission...")

    #Validate
    errors = validate_icosahedral_geodesic_dual(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_icosahedral_geodesic_dual_json(parsed_data)

    #Write file
    output_dir = Path("icosahedral-geodesic-dual")
    ...
    return {
        ...
        "category": "icosahedral-geodesic-dual",
        "id": entry_id
    }