#!/usr/bin/env python3
"""
Handler for nerc submissions.
"""

import json
from pathlib import Path

def validate_nerc(data):
    """
    Validate nerc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nerc submission...")

    #Validate
    errors = validate_nerc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nerc_json(parsed_data)

    #Write file
    output_dir = Path("nerc")
