#!/usr/bin/env python3
"""
Handler for cam submissions.
"""

import json
from pathlib import Path

def validate_cam(data):
    """
    Validate cam submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cam submission...")

    #Validate
    errors = validate_cam(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cam_json(parsed_data)
