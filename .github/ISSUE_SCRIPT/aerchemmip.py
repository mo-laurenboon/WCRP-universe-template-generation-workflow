#!/usr/bin/env python3
"""
Handler for aerchemmip submissions.
"""

import json
from pathlib import Path

def validate_aerchemmip(data):
    """
    Validate aerchemmip submission.
...
def create_aerchemmip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aerchemmip submission...")

    #Validate
    errors = validate_aerchemmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aerchemmip_json(parsed_data)

    #Write file
    output_dir = Path("aerchemmip")
