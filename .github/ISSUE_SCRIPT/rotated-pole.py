#!/usr/bin/env python3
"""
Handler for rotated-pole submissions.
"""

import json
from pathlib import Path

def validate_rotated_pole(data):
    """
    Validate rotated-pole submission.
...
def create_rotated_pole_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing rotated-pole submission...")

    #Validate
    errors = validate_rotated_pole(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_rotated_pole_json(parsed_data)

    #Write file
    output_dir = Path("rotated-pole")
