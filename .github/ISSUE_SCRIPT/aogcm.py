#!/usr/bin/env python3
"""
Handler for aogcm submissions.
"""

import json
from pathlib import Path

def validate_aogcm(data):
    """
    Validate aogcm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing aogcm submission...")

    #Validate
    errors = validate_aogcm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_aogcm_json(parsed_data)

    #Write file
    output_dir = Path("aogcm")
