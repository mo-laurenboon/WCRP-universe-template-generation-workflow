#!/usr/bin/env python3
"""
Handler for mon submissions.
"""

import json
from pathlib import Path

def validate_mon(data):
    """
    Validate mon submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mon submission...")

    #Validate
    errors = validate_mon(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mon_json(parsed_data)
