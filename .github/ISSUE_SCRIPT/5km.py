#!/usr/bin/env python3
"""
Handler for 5km submissions.
"""

import json
from pathlib import Path

def validate_5km(data):
    """
    Validate 5km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 5km submission...")

    #Validate
    errors = validate_5km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_5km_json(parsed_data)
