#!/usr/bin/env python3
"""
Handler for ucsb submissions.
"""

import json
from pathlib import Path

def validate_ucsb(data):
    """
    Validate ucsb submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ucsb submission...")

    #Validate
    errors = validate_ucsb(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ucsb_json(parsed_data)

    #Write file
    output_dir = Path("ucsb")
