#!/usr/bin/env python3
"""
Handler for gr3z submissions.
"""

import json
from pathlib import Path

def validate_gr3z(data):
    """
    Validate gr3z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr3z submission...")

    #Validate
    errors = validate_gr3z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr3z_json(parsed_data)

    #Write file
    output_dir = Path("gr3z")
