#!/usr/bin/env python3
"""
Handler for volmip submissions.
"""

import json
from pathlib import Path

def validate_volmip(data):
    """
    Validate volmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing volmip submission...")

    #Validate
    errors = validate_volmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_volmip_json(parsed_data)

    #Write file
    output_dir = Path("volmip")
