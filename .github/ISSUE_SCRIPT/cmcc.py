#!/usr/bin/env python3
"""
Handler for cmcc submissions.
"""

import json
from pathlib import Path

def validate_cmcc(data):
    """
    Validate cmcc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmcc submission...")

    #Validate
    errors = validate_cmcc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmcc_json(parsed_data)

    #Write file
    output_dir = Path("cmcc")
