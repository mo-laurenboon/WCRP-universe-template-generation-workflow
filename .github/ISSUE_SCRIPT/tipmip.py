#!/usr/bin/env python3
"""
Handler for tipmip submissions.
"""

import json
from pathlib import Path

def validate_tipmip(data):
    """
    Validate tipmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing tipmip submission...")

    #Validate
    errors = validate_tipmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_tipmip_json(parsed_data)

    #Write file
    output_dir = Path("tipmip")
