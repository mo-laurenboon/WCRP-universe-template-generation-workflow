#!/usr/bin/env python3
"""
Handler for gr5g submissions.
"""

import json
from pathlib import Path

def validate_gr5g(data):
    """
    Validate gr5g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr5g submission...")

    #Validate
    errors = validate_gr5g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr5g_json(parsed_data)

    #Write file
    output_dir = Path("gr5g")
