#!/usr/bin/env python3
"""
Handler for subhrpt submissions.
"""

import json
from pathlib import Path

def validate_subhrpt(data):
    """
    Validate subhrpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing subhrpt submission...")

    #Validate
    errors = validate_subhrpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_subhrpt_json(parsed_data)

    #Write file
    output_dir = Path("subhrpt")
