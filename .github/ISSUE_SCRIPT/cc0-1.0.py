#!/usr/bin/env python3
"""
Handler for cc0-1.0 submissions.
"""

import json
from pathlib import Path

def validate_cc0_1.0(data):
    """
    Validate cc0-1.0 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cc0-1.0 submission...")

    #Validate
    errors = validate_cc0_1.0(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cc0_1.0_json(parsed_data)

    #Write file
    output_dir = Path("cc0-1.0")
