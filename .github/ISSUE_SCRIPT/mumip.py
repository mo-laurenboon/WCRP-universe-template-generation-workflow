#!/usr/bin/env python3
"""
Handler for mumip submissions.
"""

import json
from pathlib import Path

def validate_mumip(data):
    """
    Validate mumip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mumip submission...")

    #Validate
    errors = validate_mumip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mumip_json(parsed_data)

    #Write file
    output_dir = Path("mumip")
