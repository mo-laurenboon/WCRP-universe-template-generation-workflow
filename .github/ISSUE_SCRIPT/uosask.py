#!/usr/bin/env python3
"""
Handler for uosask submissions.
"""

import json
from pathlib import Path

def validate_uosask(data):
    """
    Validate uosask submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uosask submission...")

    #Validate
    errors = validate_uosask(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uosask_json(parsed_data)

    #Write file
    output_dir = Path("uosask")
