#!/usr/bin/env python3
"""
Handler for hadgem3 submissions.
"""

import json
from pathlib import Path

def validate_hadgem3(data):
    """
    Validate hadgem3 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing hadgem3 submission...")

    #Validate
    errors = validate_hadgem3(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_hadgem3_json(parsed_data)

    #Write file
    output_dir = Path("hadgem3")
