#!/usr/bin/env python3
"""
Handler for 5000km submissions.
"""

import json
from pathlib import Path

def validate_5000km(data):
    """
    Validate 5000km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 5000km submission...")

    #Validate
    errors = validate_5000km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_5000km_json(parsed_data)

    #Write file
    output_dir = Path("5000km")
