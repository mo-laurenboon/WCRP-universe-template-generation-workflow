#!/usr/bin/env python3
"""
Handler for inpe submissions.
"""

import json
from pathlib import Path

def validate_inpe(data):
    """
    Validate inpe submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing inpe submission...")

    #Validate
    errors = validate_inpe(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_inpe_json(parsed_data)

    #Write file
    output_dir = Path("inpe")
