#!/usr/bin/env python3
"""
Handler for julian submissions.
"""

import json
from pathlib import Path

def validate_julian(data):
    """
    Validate julian submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing julian submission...")

    #Validate
    errors = validate_julian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_julian_json(parsed_data)

    #Write file
    output_dir = Path("julian")
