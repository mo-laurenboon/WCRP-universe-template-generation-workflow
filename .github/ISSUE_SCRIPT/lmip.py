#!/usr/bin/env python3
"""
Handler for lmip submissions.
"""

import json
from pathlib import Path

def validate_lmip(data):
    """
    Validate lmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing lmip submission...")

    #Validate
    errors = validate_lmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_lmip_json(parsed_data)

    #Write file
    output_dir = Path("lmip")
