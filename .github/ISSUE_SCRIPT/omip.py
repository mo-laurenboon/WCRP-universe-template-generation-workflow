#!/usr/bin/env python3
"""
Handler for omip submissions.
"""

import json
from pathlib import Path

def validate_omip(data):
    """
    Validate omip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing omip submission...")

    #Validate
    errors = validate_omip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_omip_json(parsed_data)

    #Write file
    output_dir = Path("omip")
