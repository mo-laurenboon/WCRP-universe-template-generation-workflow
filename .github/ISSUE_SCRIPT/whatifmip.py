#!/usr/bin/env python3
"""
Handler for whatifmip submissions.
"""

import json
from pathlib import Path

def validate_whatifmip(data):
    """
    Validate whatifmip submission.
...
def create_whatifmip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing whatifmip submission...")

    #Validate
    errors = validate_whatifmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_whatifmip_json(parsed_data)

    #Write file
    output_dir = Path("whatifmip")
