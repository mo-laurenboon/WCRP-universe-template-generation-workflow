#!/usr/bin/env python3
"""
Handler for gr4a submissions.
"""

import json
from pathlib import Path

def validate_gr4a(data):
    """
    Validate gr4a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr4a submission...")

    #Validate
    errors = validate_gr4a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr4a_json(parsed_data)

    #Write file
    output_dir = Path("gr4a")
