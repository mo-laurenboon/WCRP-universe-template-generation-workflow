#!/usr/bin/env python3
"""
Handler for quadratic-spectral-gaussian submissions.
"""

import json
from pathlib import Path

def validate_quadratic_spectral_gaussian(data):
    """
    Validate quadratic-spectral-gaussian submission.
...
def create_quadratic_spectral_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing quadratic-spectral-gaussian submission...")

    #Validate
    errors = validate_quadratic_spectral_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_quadratic_spectral_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("quadratic-spectral-gaussian")
    ...
    return {
        ...
        "category": "quadratic-spectral-gaussian",
        "id": entry_id
    }