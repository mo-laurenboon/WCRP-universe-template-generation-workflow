...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fx submission...")

    #Validate
    errors = validate_fx(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fx_json(parsed_data)
