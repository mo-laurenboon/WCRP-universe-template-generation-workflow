#!/usr/bin/env python3
"""
Handler for reanalysis submissions.
"""

import json
from pathlib import Path

def validate_reanalysis(data):
    """
    Validate reanalysis submission.
...
def create_reanalysis_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing reanalysis submission...")

    #Validate
    errors = validate_reanalysis(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_reanalysis_json(parsed_data)

    #Write file
    output_dir = Path("reanalysis")
