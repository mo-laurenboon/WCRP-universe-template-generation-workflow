#!/usr/bin/env python3
"""
Handler for adaptive submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing adaptive submission...")

    #Validate
    errors = validate_adaptive(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_adaptive_json(parsed_data)

    #Write file
    output_dir = Path("adaptive")
