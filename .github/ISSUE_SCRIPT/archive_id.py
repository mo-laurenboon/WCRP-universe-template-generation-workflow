#!/usr/bin/env python3
"""
Handler for archive_id submissions.
"""
...
def validate_archive_id(data):
    """
    Validate archive_id submission.
...
def create_archive_id_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing archive_id submission...")

    #Validate
    errors = validate_archive_id(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_archive_id_json(parsed_data)

    #Write file
    output_dir = Path("archive_id")
