#!/usr/bin/env python3
"""
Handler for organisation submissions.
"""
...
def validate_organisation(data):
    """
    Validate organisation submission.
...
def create_organisation_json(data):
    """
...
def run(parsed_data):
    ...
    """
    print("processing organisation submission...")

    #Validate
    errors = validate_organisation(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_organisation_json(parsed_data)

    #Write file
    output_dir = Path("organisation")
