#!/usr/bin/env python3
"""
Handler for mps submissions.
"""

import json
from pathlib import Path

def validate_mps(data):
    """
    Validate mps submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mps submission...")

    #Validate
    errors = validate_mps(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mps_json(parsed_data)
