#!/usr/bin/env python3
"""
Handler for icosahedral-geodesic submissions.
"""

import json
from pathlib import Path

def validate_icosahedral_geodesic(data):
    """
    Validate icosahedral-geodesic submission.
...
def create_icosahedral_geodesic_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing icosahedral-geodesic submission...")

    #Validate
    errors = validate_icosahedral_geodesic(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_icosahedral_geodesic_json(parsed_data)

    #Write file
    output_dir = Path("icosahedral-geodesic")
