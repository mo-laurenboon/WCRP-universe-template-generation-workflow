#!/usr/bin/env python3
"""
Handler for native_horizontal_grid_region submissions.
"""
...
def run(parsed_data):
    ...
    """
    print("processing native_horizontal_grid_region submission...")

    #Validate
    errors = validate_native_horizontal_grid_region(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_native_horizontal_grid_region_json(parsed_data)

    #Write file
    output_dir = Path("native_horizontal_grid_region")
    ...
    return {
        ...
        "category": "native_horizontal_grid_region",
        "id": entry_id
    }
