#!/usr/bin/env python3
"""
Handler for cas submissions.
"""

import json
from pathlib import Path

def validate_cas(data):
    """
    Validate cas submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cas submission...")

    #Validate
    errors = validate_cas(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cas_json(parsed_data)
