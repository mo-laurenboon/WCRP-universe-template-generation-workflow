#!/usr/bin/env python3
"""
Handler for antarctica submissions.
"""

import json
from pathlib import Path

def validate_antarctica(data):
    """
    Validate antarctica submission.
...
def create_antarctica_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing antarctica submission...")

    #Validate
    errors = validate_antarctica(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_antarctica_json(parsed_data)

    #Write file
    output_dir = Path("antarctica")
