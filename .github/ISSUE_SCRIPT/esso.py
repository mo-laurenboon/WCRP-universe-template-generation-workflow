#!/usr/bin/env python3
"""
Handler for esso submissions.
"""

import json
from pathlib import Path

def validate_esso(data):
    """
    Validate esso submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing esso submission...")

    #Validate
    errors = validate_esso(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_esso_json(parsed_data)

    #Write file
    output_dir = Path("esso")
