#!/usr/bin/env python3
"""
Handler for agcm submissions.
"""

import json
from pathlib import Path

def validate_agcm(data):
    """
    Validate agcm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing agcm submission...")

    #Validate
    errors = validate_agcm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_agcm_json(parsed_data)

    #Write file
    output_dir = Path("agcm")
