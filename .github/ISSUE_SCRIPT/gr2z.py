#!/usr/bin/env python3
"""
Handler for gr2z submissions.
"""

import json
from pathlib import Path

def validate_gr2z(data):
    """
    Validate gr2z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr2z submission...")

    #Validate
    errors = validate_gr2z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr2z_json(parsed_data)

    #Write file
    output_dir = Path("gr2z")
