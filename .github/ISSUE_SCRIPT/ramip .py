#!/usr/bin/env python3
"""
Handler for ramip  submissions.
"""

import json
from pathlib import Path

def validate_ramip (data):
    """
    Validate ramip  submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ramip  submission...")

    #Validate
    errors = validate_ramip (parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ramip _json(parsed_data)

    #Write file
    output_dir = Path("ramip ")
