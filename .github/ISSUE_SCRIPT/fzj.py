#!/usr/bin/env python3
"""
Handler for fzj submissions.
"""

import json
from pathlib import Path

def validate_fzj(data):
    """
    Validate fzj submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fzj submission...")

    #Validate
    errors = validate_fzj(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fzj_json(parsed_data)
