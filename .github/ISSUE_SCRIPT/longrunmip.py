#!/usr/bin/env python3
"""
Handler for longrunmip submissions.
"""

import json
from pathlib import Path

def validate_longrunmip(data):
    """
    Validate longrunmip submission.
...
def create_longrunmip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing longrunmip submission...")

    #Validate
    errors = validate_longrunmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_longrunmip_json(parsed_data)

    #Write file
    output_dir = Path("longrunmip")
