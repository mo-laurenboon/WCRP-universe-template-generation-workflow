#!/usr/bin/env python3
"""
Handler for niwa submissions.
"""

import json
from pathlib import Path

def validate_niwa(data):
    """
    Validate niwa submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing niwa submission...")

    #Validate
    errors = validate_niwa(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_niwa_json(parsed_data)

    #Write file
    output_dir = Path("niwa")
