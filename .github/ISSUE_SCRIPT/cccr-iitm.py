#!/usr/bin/env python3
"""
Handler for cccr-iitm submissions.
"""

import json
from pathlib import Path

def validate_cccr_iitm(data):
    """
    Validate cccr-iitm submission.
...
def create_cccr_iitm_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cccr-iitm submission...")

    #Validate
    errors = validate_cccr_iitm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cccr_iitm_json(parsed_data)

    #Write file
    output_dir = Path("cccr-iitm")
