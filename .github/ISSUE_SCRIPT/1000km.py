#!/usr/bin/env python3
"""
Handler for 1000km submissions.
"""

import json
from pathlib import Path

def validate_1000km(data):
    """
    Validate 1000km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1000km submission...")

    #Validate
    errors = validate_1000km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1000km_json(parsed_data)

    #Write file
    output_dir = Path("1000km")
