#!/usr/bin/env python3
"""
Handler for gr7g submissions.
"""

import json
from pathlib import Path

def validate_gr7g(data):
    """
    Validate gr7g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr7g submission...")

    #Validate
    errors = validate_gr7g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr7g_json(parsed_data)

    #Write file
    output_dir = Path("gr7g")
