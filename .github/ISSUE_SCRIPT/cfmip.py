#!/usr/bin/env python3
"""
Handler for cfmip submissions.
"""

import json
from pathlib import Path

def validate_cfmip(data):
    """
    Validate cfmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cfmip submission...")

    #Validate
    errors = validate_cfmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cfmip_json(parsed_data)

    #Write file
    output_dir = Path("cfmip")
