#!/usr/bin/env python3
"""
Handler for uci submissions.
"""

import json
from pathlib import Path

def validate_uci(data):
    """
    Validate uci submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uci submission...")

    #Validate
    errors = validate_uci(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uci_json(parsed_data)
