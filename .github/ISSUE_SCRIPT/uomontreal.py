#!/usr/bin/env python3
"""
Handler for uomontreal submissions.
"""

import json
from pathlib import Path

def validate_uomontreal(data):
    """
    Validate uomontreal submission.
...
def create_uomontreal_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uomontreal submission...")

    #Validate
    errors = validate_uomontreal(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uomontreal_json(parsed_data)

    #Write file
    output_dir = Path("uomontreal")
