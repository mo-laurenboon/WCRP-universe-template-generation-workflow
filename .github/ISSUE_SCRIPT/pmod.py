#!/usr/bin/env python3
"""
Handler for pmod submissions.
"""

import json
from pathlib import Path

def validate_pmod(data):
    """
    Validate pmod submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pmod submission...")

    #Validate
    errors = validate_pmod(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pmod_json(parsed_data)

    #Write file
    output_dir = Path("pmod")
