#!/usr/bin/env python3
"""
Handler for vua submissions.
"""

import json
from pathlib import Path

def validate_vua(data):
    """
    Validate vua submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing vua submission...")

    #Validate
    errors = validate_vua(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_vua_json(parsed_data)
