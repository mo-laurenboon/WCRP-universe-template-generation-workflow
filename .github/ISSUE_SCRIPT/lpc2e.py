#!/usr/bin/env python3
"""
Handler for lpc2e submissions.
"""

import json
from pathlib import Path

def validate_lpc2e(data):
    """
    Validate lpc2e submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing lpc2e submission...")

    #Validate
    errors = validate_lpc2e(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_lpc2e_json(parsed_data)

    #Write file
    output_dir = Path("lpc2e")
