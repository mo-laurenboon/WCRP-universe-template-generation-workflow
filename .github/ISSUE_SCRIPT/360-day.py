#!/usr/bin/env python3
"""
Handler for 360-day submissions.
"""

import json
from pathlib import Path

def validate_360_day(data):
    """
    Validate 360-day submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 360-day submission...")

    #Validate
    errors = validate_360_day(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_360_day_json(parsed_data)

    #Write file
    output_dir = Path("360-day")
