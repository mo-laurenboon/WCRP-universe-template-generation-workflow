#!/usr/bin/env python3
"""
Handler for osu submissions.
"""

import json
from pathlib import Path

def validate_osu(data):
    """
    Validate osu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing osu submission...")

    #Validate
    errors = validate_osu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_osu_json(parsed_data)
