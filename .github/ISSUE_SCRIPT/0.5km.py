#!/usr/bin/env python3
"""
Handler for 0.5km submissions.
"""

import json
from pathlib import Path

def validate_0.5km(data):
    """
    Validate 0.5km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 0.5km submission...")

    #Validate
    errors = validate_0.5km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_0.5km_json(parsed_data)

    #Write file
    output_dir = Path("0.5km")
