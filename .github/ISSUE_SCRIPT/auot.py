#!/usr/bin/env python3
"""
Handler for auot submissions.
"""

import json
from pathlib import Path

def validate_auot(data):
    """
    Validate auot submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing auot submission...")

    #Validate
    errors = validate_auot(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_auot_json(parsed_data)

    #Write file
    output_dir = Path("auot")
