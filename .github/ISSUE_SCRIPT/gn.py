#!/usr/bin/env python3
"""
Handler for gn submissions.
"""

import json
from pathlib import Path

def validate_gn(data):
    """
    Validate gn submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gn submission...")

    #Validate
    errors = validate_gn(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gn_json(parsed_data)
