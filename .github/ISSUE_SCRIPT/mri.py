#!/usr/bin/env python3
"""
Handler for mri submissions.
"""

import json
from pathlib import Path

def validate_mri(data):
    """
    Validate mri submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mri submission...")

    #Validate
    errors = validate_mri(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mri_json(parsed_data)
