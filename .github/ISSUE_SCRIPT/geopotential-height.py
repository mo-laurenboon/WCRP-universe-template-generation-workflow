#!/usr/bin/env python3
"""
Handler for geopotential-height submissions.
"""

import json
from pathlib import Path

def validate_geopotential_height(data):
    """
    Validate geopotential-height submission.
...
def create_geopotential_height_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing geopotential-height submission...")

    #Validate
    errors = validate_geopotential_height(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_geopotential_height_json(parsed_data)

    #Write file
    output_dir = Path("geopotential-height")
