#!/usr/bin/env python3
"""
Handler for ncar submissions.
"""

import json
from pathlib import Path

def validate_ncar(data):
    """
    Validate ncar submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ncar submission...")

    #Validate
    errors = validate_ncar(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ncar_json(parsed_data)

    #Write file
    output_dir = Path("ncar")
