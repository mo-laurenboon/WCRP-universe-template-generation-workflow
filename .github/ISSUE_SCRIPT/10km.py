#!/usr/bin/env python3
"""
Handler for 10km submissions.
"""

import json
from pathlib import Path

def validate_10km(data):
    """
    Validate 10km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 10km submission...")

    #Validate
    errors = validate_10km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_10km_json(parsed_data)

    #Write file
    output_dir = Path("10km")
