#!/usr/bin/env python3
"""
Handler for pmip submissions.
"""

import json
from pathlib import Path

def validate_pmip(data):
    """
    Validate pmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pmip submission...")

    #Validate
    errors = validate_pmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pmip_json(parsed_data)

    #Write file
    output_dir = Path("pmip")
