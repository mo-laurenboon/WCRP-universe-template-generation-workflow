#!/usr/bin/env python3
"""
Handler for uooulu submissions.
"""

import json
from pathlib import Path

def validate_uooulu(data):
    """
    Validate uooulu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing uooulu submission...")

    #Validate
    errors = validate_uooulu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_uooulu_json(parsed_data)

    #Write file
    output_dir = Path("uooulu")
