#!/usr/bin/env python3
"""
Handler for ocean-sigma-coordinate submissions.
"""

import json
from pathlib import Path

def validate_ocean_sigma_coordinate(data):
    """
    Validate ocean-sigma-coordinate submission.
...
def create_ocean_sigma_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocean-sigma-coordinate submission...")

    #Validate
    errors = validate_ocean_sigma_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocean_sigma_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("ocean-sigma-coordinate")
    ...
    return {
        ...
        "category": "ocean-sigma-coordinate",
        "id": entry_id
    }