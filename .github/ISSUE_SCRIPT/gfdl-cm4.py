#!/usr/bin/env python3
"""
Handler for gfdl-cm4 submissions.
"""

import json
from pathlib import Path

def validate_gfdl_cm4(data):
    """
    Validate gfdl-cm4 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gfdl-cm4 submission...")

    #Validate
    errors = validate_gfdl_cm4(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gfdl_cm4_json(parsed_data)

    #Write file
    output_dir = Path("gfdl-cm4")
