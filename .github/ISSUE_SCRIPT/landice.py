#!/usr/bin/env python3
"""
Handler for landice submissions.
"""

import json
from pathlib import Path

def validate_landice(data):
    """
    Validate landice submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing landice submission...")

    #Validate
    errors = validate_landice(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_landice_json(parsed_data)

    #Write file
    output_dir = Path("landice")
