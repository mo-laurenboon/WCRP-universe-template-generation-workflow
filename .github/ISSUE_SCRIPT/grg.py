#!/usr/bin/env python3
"""
Handler for grg submissions.
"""

import json
from pathlib import Path

def validate_grg(data):
    """
    Validate grg submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing grg submission...")

    #Validate
    errors = validate_grg(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_grg_json(parsed_data)
