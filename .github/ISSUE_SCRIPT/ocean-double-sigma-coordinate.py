#!/usr/bin/env python3
"""
Handler for ocean-double-sigma-coordinate submissions.
"""

import json
from pathlib import Path

def validate_ocean_double_sigma_coordinate(data):
    """
    Validate ocean-double-sigma-coordinate submission.
...
def create_ocean_double_sigma_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocean-double-sigma-coordinate submission...")

    #Validate
    errors = validate_ocean_double_sigma_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocean_double_sigma_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("ocean-double-sigma-coordinate")
    ...
    return {
        ...
        "category": "ocean-double-sigma-coordinate",
        "id": entry_id
    }