#!/usr/bin/env python3
"""
Handler for gr8 submissions.
"""

import json
from pathlib import Path

def validate_gr8(data):
    """
    Validate gr8 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr8 submission...")

    #Validate
    errors = validate_gr8(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr8_json(parsed_data)
