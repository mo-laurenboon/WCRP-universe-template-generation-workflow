#!/usr/bin/env python3
"""
Handler for product submissions.
"""
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing product submission...")

    #Validate
    errors = validate_product(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_product_json(parsed_data)
