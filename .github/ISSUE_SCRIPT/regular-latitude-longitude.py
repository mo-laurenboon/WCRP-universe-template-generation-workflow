#!/usr/bin/env python3
"""
Handler for regular-latitude-longitude submissions.
"""

import json
from pathlib import Path

def validate_regular_latitude_longitude(data):
    """
    Validate regular-latitude-longitude submission.
...
def create_regular_latitude_longitude_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing regular-latitude-longitude submission...")

    #Validate
    errors = validate_regular_latitude_longitude(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_regular_latitude_longitude_json(parsed_data)

    #Write file
    output_dir = Path("regular-latitude-longitude")
    ...
    return {
        ...
        "category": "regular-latitude-longitude",
        "id": entry_id
    }