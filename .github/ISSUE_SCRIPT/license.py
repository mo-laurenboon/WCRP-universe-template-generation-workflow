...
def run(parsed_data):
    ...
    #Validate
    errors = validate_license(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_license_json(parsed_data)

    #Write file
    output_dir = Path("license")
