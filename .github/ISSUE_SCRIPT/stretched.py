#!/usr/bin/env python3
"""
Handler for stretched submissions.
"""

import json
from pathlib import Path

def validate_stretched(data):
    """
    Validate stretched submission.
...
def create_stretched_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing stretched submission...")

    #Validate
    errors = validate_stretched(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_stretched_json(parsed_data)

    #Write file
    output_dir = Path("stretched")
