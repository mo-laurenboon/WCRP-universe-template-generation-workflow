#!/usr/bin/env python3
"""
Handler for linear-spectral-gaussian submissions.
"""

import json
from pathlib import Path

def validate_linear_spectral_gaussian(data):
    """
    Validate linear-spectral-gaussian submission.
...
def create_linear_spectral_gaussian_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing linear-spectral-gaussian submission...")

    #Validate
    errors = validate_linear_spectral_gaussian(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_linear_spectral_gaussian_json(parsed_data)

    #Write file
    output_dir = Path("linear-spectral-gaussian")
    ...
    return {
        ...
        "category": "linear-spectral-gaussian",
        "id": entry_id
    }