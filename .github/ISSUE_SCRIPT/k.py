...
def run(parsed_data, issue_data):
    ...
    """
    print("processing k submission...")

    #Validate
    errors = validate_k(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_k_json(parsed_data)
