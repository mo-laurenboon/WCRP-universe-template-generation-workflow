#!/usr/bin/env python3
"""
Handler for solaris-heppa submissions.
"""

import json
from pathlib import Path

def validate_solaris_heppa(data):
    """
    Validate solaris-heppa submission.
...
def create_solaris_heppa_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing solaris-heppa submission...")

    #Validate
    errors = validate_solaris_heppa(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_solaris_heppa_json(parsed_data)

    #Write file
    output_dir = Path("solaris-heppa")
