#!/usr/bin/env python3
"""
Handler for ntu submissions.
"""

import json
from pathlib import Path

def validate_ntu(data):
    """
    Validate ntu submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ntu submission...")

    #Validate
    errors = validate_ntu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ntu_json(parsed_data)
