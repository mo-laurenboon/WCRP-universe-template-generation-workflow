#!/usr/bin/env python3
"""
Handler for simip submissions.
"""

import json
from pathlib import Path

def validate_simip(data):
    """
    Validate simip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing simip submission...")

    #Validate
    errors = validate_simip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_simip_json(parsed_data)

    #Write file
    output_dir = Path("simip")
