#!/usr/bin/env python3
"""
Handler for highresmip submissions.
"""

import json
from pathlib import Path

def validate_highresmip(data):
    """
    Validate highresmip submission.
...
def create_highresmip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing highresmip submission...")

    #Validate
    errors = validate_highresmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_highresmip_json(parsed_data)

    #Write file
    output_dir = Path("highresmip")
