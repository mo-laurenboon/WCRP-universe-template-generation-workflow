#!/usr/bin/env python3
"""
Handler for gr2g submissions.
"""

import json
from pathlib import Path

def validate_gr2g(data):
    """
    Validate gr2g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr2g submission...")

    #Validate
    errors = validate_gr2g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr2g_json(parsed_data)

    #Write file
    output_dir = Path("gr2g")
