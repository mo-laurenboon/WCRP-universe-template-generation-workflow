#!/usr/bin/env python3
"""
Handler for nasa-jpl submissions.
"""

import json
from pathlib import Path

def validate_nasa_jpl(data):
    """
    Validate nasa-jpl submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nasa-jpl submission...")

    #Validate
    errors = validate_nasa_jpl(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nasa_jpl_json(parsed_data)

    #Write file
    output_dir = Path("nasa-jpl")
