#!/usr/bin/env python3
"""
Handler for ifm-geomar submissions.
"""

import json
from pathlib import Path

def validate_ifm_geomar(data):
    """
    Validate ifm-geomar submission.
...
def create_ifm_geomar_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ifm-geomar submission...")

    #Validate
    errors = validate_ifm_geomar(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ifm_geomar_json(parsed_data)

    #Write file
    output_dir = Path("ifm-geomar")
