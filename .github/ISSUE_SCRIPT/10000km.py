#!/usr/bin/env python3
"""
Handler for 10000km submissions.
"""

import json
from pathlib import Path

def validate_10000km(data):
    """
    Validate 10000km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 10000km submission...")

    #Validate
    errors = validate_10000km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_10000km_json(parsed_data)

    #Write file
    output_dir = Path("10000km")
