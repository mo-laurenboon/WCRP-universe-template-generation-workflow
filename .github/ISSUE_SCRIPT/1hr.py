#!/usr/bin/env python3
"""
Handler for 1hr submissions.
"""

import json
from pathlib import Path

def validate_1hr(data):
    """
    Validate 1hr submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1hr submission...")

    #Validate
    errors = validate_1hr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1hr_json(parsed_data)
