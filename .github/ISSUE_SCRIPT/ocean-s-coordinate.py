#!/usr/bin/env python3
"""
Handler for ocean-s-coordinate submissions.
"""

import json
from pathlib import Path

def validate_ocean_s_coordinate(data):
    """
    Validate ocean-s-coordinate submission.
...
def create_ocean_s_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ocean-s-coordinate submission...")

    #Validate
    errors = validate_ocean_s_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ocean_s_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("ocean-s-coordinate")
