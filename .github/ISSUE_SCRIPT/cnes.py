#!/usr/bin/env python3
"""
Handler for cnes submissions.
"""

import json
from pathlib import Path

def validate_cnes(data):
    """
    Validate cnes submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cnes submission...")

    #Validate
    errors = validate_cnes(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cnes_json(parsed_data)

    #Write file
    output_dir = Path("cnes")
