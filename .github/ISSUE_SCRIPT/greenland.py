#!/usr/bin/env python3
"""
Handler for greenland submissions.
"""

import json
from pathlib import Path

def validate_greenland(data):
    """
    Validate greenland submission.
...
def create_greenland_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing greenland submission...")

    #Validate
    errors = validate_greenland(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_greenland_json(parsed_data)

    #Write file
    output_dir = Path("greenland")
