#!/usr/bin/env python3
"""
Handler for cesm submissions.
"""

import json
from pathlib import Path

def validate_cesm(data):
    """
    Validate cesm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cesm submission...")

    #Validate
    errors = validate_cesm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cesm_json(parsed_data)

    #Write file
    output_dir = Path("cesm")
