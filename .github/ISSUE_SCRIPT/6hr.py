#!/usr/bin/env python3
"""
Handler for 6hr submissions.
"""

import json
from pathlib import Path

def validate_6hr(data):
    """
    Validate 6hr submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 6hr submission...")

    #Validate
    errors = validate_6hr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_6hr_json(parsed_data)
