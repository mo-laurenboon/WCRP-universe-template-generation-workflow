#!/usr/bin/env python3
"""
Handler for 1x1degree submissions.
"""

import json
from pathlib import Path

def validate_1x1degree(data):
    """
    Validate 1x1degree submission.
...
def create_1x1degree_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 1x1degree submission...")

    #Validate
    errors = validate_1x1degree(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_1x1degree_json(parsed_data)

    #Write file
    output_dir = Path("1x1degree")
