#!/usr/bin/env python3
"""
Handler for as-rcec submissions.
"""

import json
from pathlib import Path

def validate_as_rcec(data):
    """
    Validate as-rcec submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing as-rcec submission...")

    #Validate
    errors = validate_as_rcec(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_as_rcec_json(parsed_data)

    #Write file
    output_dir = Path("as-rcec")
