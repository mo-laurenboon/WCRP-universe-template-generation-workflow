...
def run(parsed_data, issue_data):
    ...
    """
    print("processing m submission...")

    #Validate
    errors = validate_m(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_m_json(parsed_data)
