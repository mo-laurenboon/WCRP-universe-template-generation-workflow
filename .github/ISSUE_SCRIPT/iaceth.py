#!/usr/bin/env python3
"""
Handler for iaceth submissions.
"""

import json
from pathlib import Path

def validate_iaceth(data):
    """
    Validate iaceth submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing iaceth submission...")

    #Validate
    errors = validate_iaceth(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_iaceth_json(parsed_data)

    #Write file
    output_dir = Path("iaceth")
