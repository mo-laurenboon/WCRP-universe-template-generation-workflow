#!/usr/bin/env python3
"""
Handler for gridded-insitu submissions.
"""

import json
from pathlib import Path

def validate_gridded_insitu(data):
    """
    Validate gridded-insitu submission.
...
def create_gridded_insitu_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gridded-insitu submission...")

    #Validate
    errors = validate_gridded_insitu(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gridded_insitu_json(parsed_data)

    #Write file
    output_dir = Path("gridded-insitu")
