...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cr submission...")

    #Validate
    errors = validate_cr(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cr_json(parsed_data)
