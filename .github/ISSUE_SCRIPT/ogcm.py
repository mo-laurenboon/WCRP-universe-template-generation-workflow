#!/usr/bin/env python3
"""
Handler for ogcm submissions.
"""

import json
from pathlib import Path

def validate_ogcm(data):
    """
    Validate ogcm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ogcm submission...")

    #Validate
    errors = validate_ogcm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ogcm_json(parsed_data)

    #Write file
    output_dir = Path("ogcm")
