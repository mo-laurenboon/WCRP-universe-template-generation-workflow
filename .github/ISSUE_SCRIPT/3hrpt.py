#!/usr/bin/env python3
"""
Handler for 3hrpt submissions.
"""

import json
from pathlib import Path

def validate_3hrpt(data):
    """
    Validate 3hrpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 3hrpt submission...")

    #Validate
    errors = validate_3hrpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_3hrpt_json(parsed_data)

    #Write file
    output_dir = Path("3hrpt")
