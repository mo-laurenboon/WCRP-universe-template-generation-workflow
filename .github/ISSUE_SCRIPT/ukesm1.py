#!/usr/bin/env python3
"""
Handler for ukesm1 submissions.
"""

import json
from pathlib import Path

def validate_ukesm1(data):
    """
    Validate ukesm1 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ukesm1 submission...")

    #Validate
    errors = validate_ukesm1(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ukesm1_json(parsed_data)

    #Write file
    output_dir = Path("ukesm1")
