#!/usr/bin/env python3
"""
Handler for gr7z submissions.
"""

import json
from pathlib import Path

def validate_gr7z(data):
    """
    Validate gr7z submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr7z submission...")

    #Validate
    errors = validate_gr7z(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr7z_json(parsed_data)

    #Write file
    output_dir = Path("gr7z")
