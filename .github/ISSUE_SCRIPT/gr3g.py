#!/usr/bin/env python3
"""
Handler for gr3g submissions.
"""

import json
from pathlib import Path

def validate_gr3g(data):
    """
    Validate gr3g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr3g submission...")

    #Validate
    errors = validate_gr3g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr3g_json(parsed_data)

    #Write file
    output_dir = Path("gr3g")
