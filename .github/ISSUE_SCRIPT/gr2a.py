#!/usr/bin/env python3
"""
Handler for gr2a submissions.
"""

import json
from pathlib import Path

def validate_gr2a(data):
    """
    Validate gr2a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr2a submission...")

    #Validate
    errors = validate_gr2a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr2a_json(parsed_data)

    #Write file
    output_dir = Path("gr2a")
