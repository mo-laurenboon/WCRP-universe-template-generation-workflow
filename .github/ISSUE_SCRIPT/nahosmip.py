#!/usr/bin/env python3
"""
Handler for nahosmip submissions.
"""

import json
from pathlib import Path

def validate_nahosmip(data):
    """
    Validate nahosmip submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing nahosmip submission...")

    #Validate
    errors = validate_nahosmip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_nahosmip_json(parsed_data)

    #Write file
    output_dir = Path("nahosmip")
