#!/usr/bin/env python3
"""
Handler for methanemip submissions.
"""

import json
from pathlib import Path

def validate_methanemip(data):
    """
    Validate methanemip submission.
...
def create_methanemip_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing methanemip submission...")

    #Validate
    errors = validate_methanemip(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_methanemip_json(parsed_data)

    #Write file
    output_dir = Path("methanemip")
