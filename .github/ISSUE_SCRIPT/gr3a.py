#!/usr/bin/env python3
"""
Handler for gr3a submissions.
"""

import json
from pathlib import Path

def validate_gr3a(data):
    """
    Validate gr3a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr3a submission...")

    #Validate
    errors = validate_gr3a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr3a_json(parsed_data)

    #Write file
    output_dir = Path("gr3a")
