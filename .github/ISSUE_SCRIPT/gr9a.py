#!/usr/bin/env python3
"""
Handler for gr9a submissions.
"""

import json
from pathlib import Path

def validate_gr9a(data):
    """
    Validate gr9a submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr9a submission...")

    #Validate
    errors = validate_gr9a(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr9a_json(parsed_data)

    #Write file
    output_dir = Path("gr9a")
