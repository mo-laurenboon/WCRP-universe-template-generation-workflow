#!/usr/bin/env python3
"""
Handler for atmosphere-ln-pressure-coordinate submissions.
"""

import json
from pathlib import Path

def validate_atmosphere_ln_pressure_coordinate(data):
    """
    Validate atmosphere-ln-pressure-coordinate submission.
...
def create_atmosphere_ln_pressure_coordinate_json(data):
    """
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing atmosphere-ln-pressure-coordinate submission...")

    #Validate
    errors = validate_atmosphere_ln_pressure_coordinate(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_atmosphere_ln_pressure_coordinate_json(parsed_data)

    #Write file
    output_dir = Path("atmosphere-ln-pressure-coordinate")
    ...
    return {
        ...
        "category": "atmosphere-ln-pressure-coordinate",
        "id": entry_id
    }