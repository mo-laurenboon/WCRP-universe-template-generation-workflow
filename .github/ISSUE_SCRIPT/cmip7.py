#!/usr/bin/env python3
"""
Handler for cmip7 submissions.
"""

import json
from pathlib import Path

def validate_cmip7(data):
    """
    Validate cmip7 submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cmip7 submission...")

    #Validate
    errors = validate_cmip7(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cmip7_json(parsed_data)

    #Write file
    output_dir = Path("cmip7")
