#!/usr/bin/env python3
"""
Handler for pa submissions.
"""

import json
from pathlib import Path

def validate_pa(data):
    """
    Validate pa submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing pa submission...")

    #Validate
    errors = validate_pa(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_pa_json(parsed_data)
