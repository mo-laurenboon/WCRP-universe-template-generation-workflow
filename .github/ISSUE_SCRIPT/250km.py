#!/usr/bin/env python3
"""
Handler for 250km submissions.
"""

import json
from pathlib import Path

def validate_250km(data):
    """
    Validate 250km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 250km submission...")

    #Validate
    errors = validate_250km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_250km_json(parsed_data)

    #Write file
    output_dir = Path("250km")
