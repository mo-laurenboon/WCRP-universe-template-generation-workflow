#!/usr/bin/env python3
"""
Handler for ifs submissions.
"""

import json
from pathlib import Path

def validate_ifs(data):
    """
    Validate ifs submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ifs submission...")

    #Validate
    errors = validate_ifs(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ifs_json(parsed_data)
