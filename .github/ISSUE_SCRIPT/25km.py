#!/usr/bin/env python3
"""
Handler for 25km submissions.
"""

import json
from pathlib import Path

def validate_25km(data):
    """
    Validate 25km submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing 25km submission...")

    #Validate
    errors = validate_25km(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_25km_json(parsed_data)

    #Write file
    output_dir = Path("25km")
