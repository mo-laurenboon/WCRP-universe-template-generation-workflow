#!/usr/bin/env python3
"""
Handler for chem submissions.
"""

import json
from pathlib import Path

def validate_chem(data):
    """
    Validate chem submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing chem submission...")

    #Validate
    errors = validate_chem(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_chem_json(parsed_data)

    #Write file
    output_dir = Path("chem")
