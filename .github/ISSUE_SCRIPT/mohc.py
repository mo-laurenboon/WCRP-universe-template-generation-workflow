#!/usr/bin/env python3
"""
Handler for mohc submissions.
"""

import json
from pathlib import Path

def validate_mohc(data):
    """
    Validate mohc submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing mohc submission...")

    #Validate
    errors = validate_mohc(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_mohc_json(parsed_data)

    #Write file
    output_dir = Path("mohc")
