#!/usr/bin/env python3
"""
Handler for cccma submissions.
"""

import json
from pathlib import Path

def validate_cccma(data):
    """
    Validate cccma submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing cccma submission...")

    #Validate
    errors = validate_cccma(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_cccma_json(parsed_data)

    #Write file
    output_dir = Path("cccma")
