#!/usr/bin/env python3
"""
Handler for bas submissions.
"""

import json
from pathlib import Path

def validate_bas(data):
    """
    Validate bas submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing bas submission...")

    #Validate
    errors = validate_bas(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_bas_json(parsed_data)
