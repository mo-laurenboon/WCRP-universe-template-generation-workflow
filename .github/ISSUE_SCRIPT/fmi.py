#!/usr/bin/env python3
"""
Handler for fmi submissions.
"""

import json
from pathlib import Path

def validate_fmi(data):
    """
    Validate fmi submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing fmi submission...")

    #Validate
    errors = validate_fmi(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_fmi_json(parsed_data)
