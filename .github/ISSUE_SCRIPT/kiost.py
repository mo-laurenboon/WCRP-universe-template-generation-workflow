#!/usr/bin/env python3
"""
Handler for kiost submissions.
"""

import json
from pathlib import Path

def validate_kiost(data):
    """
    Validate kiost submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing kiost submission...")

    #Validate
    errors = validate_kiost(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_kiost_json(parsed_data)

    #Write file
    output_dir = Path("kiost")
