#!/usr/bin/env python3
"""
Handler for gr6g submissions.
"""

import json
from pathlib import Path

def validate_gr6g(data):
    """
    Validate gr6g submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing gr6g submission...")

    #Validate
    errors = validate_gr6g(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_gr6g_json(parsed_data)

    #Write file
    output_dir = Path("gr6g")
