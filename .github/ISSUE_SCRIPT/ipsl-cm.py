#!/usr/bin/env python3
"""
Handler for ipsl-cm submissions.
"""

import json
from pathlib import Path

def validate_ipsl_cm(data):
    """
    Validate ipsl-cm submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing ipsl-cm submission...")

    #Validate
    errors = validate_ipsl_cm(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_ipsl_cm_json(parsed_data)

    #Write file
    output_dir = Path("ipsl-cm")
