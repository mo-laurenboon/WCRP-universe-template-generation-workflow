#!/usr/bin/env python3
"""
Handler for monpt submissions.
"""

import json
from pathlib import Path

def validate_monpt(data):
    """
    Validate monpt submission.
...
def run(parsed_data, issue_data):
    ...
    """
    print("processing monpt submission...")

    #Validate
    errors = validate_monpt(parsed_data)
    if errors:
    ...
    #Create JSON
    entry = create_monpt_json(parsed_data)

    #Write file
    output_dir = Path("monpt")
